...
/// Devoid (CR 702.114) supplies an intrinsic color definition in every zone
/// and outside the game, before ordinary color changes and ability removal.
#[must_use]
...
include!("abilities/payment_keywords.rs");
include!("abilities/optional_additional_costs.rs");
include!("abilities/storm.rs");
include!("abilities/dash.rs");
include!("abilities/warp.rs");
