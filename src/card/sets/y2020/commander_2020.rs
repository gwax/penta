...
const MURMURING_MYSTIC_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2018::guilds_of_ravnica::MURMURING_MYSTIC)
        .with_art("ab25853c-29d3-4244-88db-813300a262a5", "Mark Winters");
