...
pub(in crate::card::sets) static LENA_SELFLESS_CHAMPION: CardRecord = CardRecord::new(
    "Lena, Selfless Champion",
    "2ffcbcda-2ba3-45e7-80c0-85ea3b7eea0c",
    "Lucas Graciano",
    CardRules::new_creature(mana_cost!("{4}{W}{W}"), &["Human", "Knight"], 3, 3)
        .with_supertype(CardSupertype::Legendary)
        .with_abilities(&[
            abilities::enters_trigger(
                "When Lena enters, create a 1/1 white Soldier creature token \
            ...
            AbilityDef::activated(
                "Sacrifice Lena: Creatures you control with power less than \
...
// M19 61 — Mirror Image
pub(in crate::card::sets) static MIRROR_IMAGE: CardRecord = CardRecord::new(
    "Mirror Image",
...
pub(in crate::card::sets) static SAI_MASTER_THOPTERIST: CardRecord = CardRecord::new(
...
pub(in crate::card::sets) static STITCHER_S_SUPPLIER: CardRecord = CardRecord::new(
    "Stitcher's Supplier",
    "2b737126-50b5-4678-91bf-197b64086fe4",
    "Chris Seaman",
    CardRules::new_creature(mana_cost!("{B}"), &["Zombie"], 1, 1).with_abilities(&[
        AbilityDef::triggered(
            "When this creature enters or dies, mill three cards. (Put \
...
pub(in crate::card::sets) static ALPINE_MOON: CardRecord = CardRecord::new(
    ...
    CardRules::new_enchantment(mana_cost!("{R}")).with_abilities(&[
        ...
        AbilityDef::static_ability(
            "Lands your opponents control with the chosen name lose all \
             land types and abilities, and they gain \"{T}: Add one mana \
             of any color.\"",
...
pub(in crate::card::sets) static APEX_OF_POWER: CardRecord = CardRecord::new(
    "Apex of Power",
    "c827bccf-38f9-4a7c-bd0e-038594a9f63b",
    "Svetlin Velinov",
    CardRules::new_sorcery(mana_cost!("{7}{R}{R}{R}")).with_abilities(&[AbilityDef::spell(
        "Exile the top seven cards of your library. Until end of \
         turn, you may cast spells from among them.\nIf this spell \
         was cast from your hand, add ten mana of any one color.",
        EffectDef::Sequence(&[
            ...
            EffectDef::IfCondition {
                ...
                then: &EffectDef::AddMana(AddManaEffectDef::any_color().with_amount(10)),
            },
        ]),
    )]),
);
...
pub(in crate::card::sets) static GOBLIN_TRASHMASTER: CardRecord = CardRecord::new(
    "Goblin Trashmaster",
...
pub(in crate::card::sets) static GORECLAW_TERROR_OF_QAL_SISMA: CardRecord = CardRecord::new(
    "Goreclaw, Terror of Qal Sisma",
    "36d4574a-3266-4497-b145-fb25820d8a7f",
    "Svetlin Velinov",
    CardRules::new_creature(mana_cost!("{3}{G}"), &["Bear"], 4, 3)
        .with_supertype(CardSupertype::Legendary)
        .with_abilities(&[
            AbilityDef::static_ability(
            ...
            AbilityDef::triggered(
                "Whenever Goreclaw attacks, each creature you control with \
                 power 4 or greater gets +1/+1 and gains trample until end \
                 of turn.",
                TriggerEventDef::attacks(ObjectPredicateDef::Source),
                EffectDef::Apply {
                    recipient: EffectRecipientDef::matching_objects(
...
pub(in crate::card::sets) static NEXUS_OF_FATE: CardRecord = CardRecord::new(
    "Nexus of Fate",
    ...
    CardRules::new_instant(mana_cost!("{5}{U}{U}")).with_abilities(&[
        ...
        AbilityDef::replacement_for(
            "If Nexus of Fate would be put into a graveyard from \
             anywhere, reveal Nexus of Fate and shuffle it into its \
