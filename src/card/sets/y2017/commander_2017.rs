    ...
    CardRules::new_instant(mana_cost!("{2}{W}")).with_ability(
        AbilityDef::spell(
            "Until your next turn, your life total can't change and you \
             gain protection from everything. All permanents you control \
             phase out. (While they're phased out, they're treated as \
             though they don't exist. They phase in before you untap \
...
pub(in crate::card::sets) static BLOODLINE_NECROMANCER: CardRecord = CardRecord::new(
...
// Audit: unsupported — Attack-declaration predicates do not identify the player being attacked
// relative to the Aura’s enchanted player; triggering once per attacker would overproduce Gold.
pub(in crate::card::sets) static CURSE_OF_OPULENCE: CardRecord = CardRecord::new(
    "Curse of Opulence",
...
// Audit: unsupported — The shared battlefield-event listener does not register abilities of
// command-zone cards, so eminence cannot observe another Wizard entering while Inalla is in the
// command zone.
pub(in crate::card::sets) static INALLA_ARCHMAGE_RITUALIST: CardRecord = CardRecord::new(
...
pub(in crate::card::sets) static HERALD_S_HORN: CardRecord = CardRecord::new(
    "Herald's Horn",
    ...
    CardRules::new_artifact(mana_cost!("{3}")).with_abilities(&[
        ...
        AbilityDef::triggered(
            "At the beginning of your upkeep, look at the top card of \
             your library. If it's a creature card of the chosen type, \
            ...
            EffectDef::BindObjects(BindObjectsDef {
                ...
                then: &EffectDef::Sequence(&[
                    ...
                    EffectDef::ForEachInBinding {
                        objects: Binding!("horn_top"),
                        binding: Binding!("horn_card"),
...
pub(in crate::card::sets) static MIRROR_OF_THE_FOREBEARS: CardRecord = CardRecord::new(
    ...
    CardRules::new_artifact(mana_cost!("{2}")).with_abilities(&[
        ...
        AbilityDef::activated_with_targets(
            "{1}: Until end of turn, this artifact becomes a copy of \
             target creature you control of the chosen type, except it's \
...
// Audit: unsupported — Mana types cannot be derived from designated commanders’ color
// identities, and spend effects cannot compare the spell’s creature types with a commander.
pub(in crate::card::sets) static PATH_OF_ANCESTRY: CardRecord = CardRecord::new(
    "Path of Ancestry",
...
pub(in crate::card::sets) static CARDS: &[&CardRecord] = &[
    &TEFERIS_PROTECTION,
    &BLOODLINE_NECROMANCER,
    &CURSE_OF_OPULENCE,
    &FRACTURED_IDENTITY,
    &INALLA_ARCHMAGE_RITUALIST,
    &HERALD_S_HORN,
    &MIRROR_OF_THE_FOREBEARS,
    &RAMOS_DRAGON_ENGINE,
    &PATH_OF_ANCESTRY,
];
