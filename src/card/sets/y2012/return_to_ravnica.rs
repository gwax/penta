...
use crate::card::sets::y1999::mercadian_masques as mmq;
...
const WURM_TOKEN: TokenCharacteristics =
...
pub(in crate::card::sets) static ANGEL_OF_SERENITY: CardRecord = CardRecord::new(
    ...
    "Aleksi Briclot",
    CardRules::new_creature(mana_cost!("{4}{W}{W}{W}"), &["Angel"], 5, 6).with_abilities(&[
        abilities::flying(),
        abilities::enters_trigger_with_targets(
            "When this creature enters, you may exile up to three other \
             target creatures from the battlefield and/or creature cards \
             from graveyards.",
...
pub(in crate::card::sets) static ARMORY_GUARD: CardRecord = CardRecord::new(
    "Armory Guard",
    "c03498c1-b7f7-41fb-8e2a-1c087d4e9990",
    "Karl Kopinski",
...
const ARREST_REPRINT: PrintingRecord = PrintingRecord::reprint(
    &mmq::ARREST,
    "498f74a2-7e5e-4082-97e7-b938d703f869",
    "Greg Staples",
);
...
pub(in crate::card::sets) static AVENGING_ARROW: CardRecord = CardRecord::new(
    "Avenging Arrow",
    "696678ff-44dc-4fe4-bf17-024e86cd0220",
    "James Ryman",
...
pub(in crate::card::sets) static AZORIUS_ARRESTER: CardRecord = CardRecord::new(
    "Azorius Arrester",
    "199f7563-563e-483c-8317-5380a83db955",
    "Wayne Reynolds",
...
pub(in crate::card::sets) static AZORIUS_JUSTICIAR: CardRecord = CardRecord::new(
    "Azorius Justiciar",
    "9f56272e-c05e-446b-8871-e3783dd29a8b",
    "Chris Rahn",
    ...
    CardRules::new_creature(mana_cost!("{4}{W}"), &["Beast"], 2, 5).with_ability(
        AbilityDef::triggered_with_targets(
            "Whenever this creature attacks, another target attacking \
             creature gets +0/+2 until end of turn. Untap that creature.",
...
pub(in crate::card::sets) static ETHEREAL_ARMOR: CardRecord = CardRecord::new(
    "Ethereal Armor",
    "76960e65-e5c7-4414-b9a5-37d7b2ded4a0",
    "Daarken",
...
pub(in crate::card::sets) static EYES_IN_THE_SKIES: CardRecord = CardRecord::new(
    "Eyes in the Skies",
    "befef095-3429-4dd7-aa01-2f7f619675d4",
    "James Ryman",
...
pub(in crate::card::sets) static KEENING_APPARITION: CardRecord = CardRecord::new(
    "Keening Apparition",
    "657b242c-46cb-44d1-86fd-fb2485144a5b",
    "Terese Nielsen",
...
pub(in crate::card::sets) static KNIGHTLY_VALOR: CardRecord = CardRecord::new(
    "Knightly Valor",
    "122d821f-c8dd-4a3c-a6d7-b42fe5491f02",
    "Matt Stewart",
    CardRules::new_enchantment(mana_cost!("{4}{W}"))
        ...
        .with_abilities(&[
            ...
            abilities::enters_trigger(
                ...
                EffectDef::CreateToken(CreateTokenDef::new(TokenDef::Literal(KNIGHT_TOKEN))),
            ),
            AbilityDef::static_ability(
...
pub(in crate::card::sets) static MARTIAL_LAW: CardRecord = CardRecord::new(
    "Martial Law",
    "21078b6f-a39d-4ec8-879e-ad10d97c3ff6",
    "Tyler Jacobson",
...
// Audit: unsupported — Needs a damage-redirection replacement covering you and every other
// permanent you control.
pub(in crate::card::sets) static PALISADE_GIANT: CardRecord = CardRecord::new(
    "Palisade Giant",
    "fdfd37ca-e4c9-4674-a75f-15d8ebcce72b",
    "Greg Staples",
...
pub(in crate::card::sets) static PRECINCT_CAPTAIN: CardRecord = CardRecord::new(
    "Precinct Captain",
    "5f1f6178-4071-401f-bd0d-cac0c5967661",
    "Steve Prescott",
        ...
        AbilityDef::triggered(
            ...
            EffectDef::CreateToken(CreateTokenDef::new(TokenDef::Literal(
                TokenCharacteristics::creature(&["Soldier"], &[ManaColor::White], 1, 1).with_art(
                    CardArt::new("944a40e8-5469-4d8b-b044-67ff3382ec92", "Steve Prescott"),
                ),
            ))),
        ),
    ]),
...
pub(in crate::card::sets) static ROOTBORN_DEFENSES: CardRecord = CardRecord::new(
    "Rootborn Defenses",
    "deccfa48-b8df-4dcc-ba1b-920f8352def7",
    "Mark Zug",
...
pub(in crate::card::sets) static SECURITY_BLOCKADE: CardRecord = CardRecord::new(
    "Security Blockade",
    "e6250b31-8592-48b2-a877-3637c9ee7d49",
    "James Ryman",
...
pub(in crate::card::sets) static SOUL_TITHE: CardRecord = CardRecord::new(
    "Soul Tithe",
    "77e546ce-f498-4136-9015-bb262c301716",
    "Dave Kendall",
        ...
        .with_abilities(&[
            ...
            AbilityDef::triggered(
                "At the beginning of the upkeep of enchanted permanent's \
                 controller, that player sacrifices it unless they pay {X}, \
...
// Audit: unsupported — Needs a per-attacker combat tax whose amount dynamically counts
// enchantments you control.
pub(in crate::card::sets) static SPHERE_OF_SAFETY: CardRecord = CardRecord::new(
    "Sphere of Safety",
    "ce3bd0d8-7e44-4cf2-9012-8ff0bc39417f",
    "Slawomir Maniak",
    crate::card::CardRules::unsupported(),
);
...
pub(in crate::card::sets) static SWIFT_JUSTICE: CardRecord = CardRecord::new(
    "Swift Justice",
    "a94801ba-0295-4611-abda-4c6508d69cc3",
    "Karl Kopinski",
...
pub(in crate::card::sets) static AQUUS_STEED: CardRecord = CardRecord::new(
    "Aquus Steed",
    "af643949-7a9b-4195-8ab8-d43b1928b85a",
    "Warren Mahy",
...
pub(in crate::card::sets) static BLUSTERSQUALL: CardRecord = CardRecord::new(
    "Blustersquall",
    "d998847b-323d-406a-b08e-0da66edcc7b3",
    "Willian Murai",
...
const CANCEL_REPRINT: PrintingRecord = PrintingRecord::reprint(
    ...
    "fd994a26-65ff-43be-8d52-476e887d3ed2",
    "Karl Kopinski",
);
...
pub(in crate::card::sets) static CHRONIC_FLOODING: CardRecord = CardRecord::new(
    "Chronic Flooding",
    "1a757425-3cf2-4aca-b415-5ec2d5f753fe",
    "Scott Chou",
...
pub(in crate::card::sets) static CONJURED_CURRENCY: CardRecord = CardRecord::new(
    "Conjured Currency",
    "a7c2ea6e-7d29-4526-b135-9bbb1eed9d4a",
    "Steve Argyle",
    CardRules::new_enchantment(mana_cost!("{5}{U}")).with_ability(
        AbilityDef::triggered_with_targets(
            "At the beginning of your upkeep, you may exchange control \
             of this enchantment and target permanent you neither own \
             nor control.",
            TriggerEventDef::StepBegins {
                step: TurnStepDef::Upkeep,
                player: PlayerRelation::You,
...
pub(in crate::card::sets) static CROSSTOWN_COURIER: CardRecord = CardRecord::new(
    "Crosstown Courier",
    "8c8875a3-9f56-4947-9655-aa5d95f06de0",
    "Chase Stone",
...
const DISPEL_REPRINT: PrintingRecord = PrintingRecord::reprint(
    &crate::card::sets::y2010::worldwake::DISPEL,
...
pub(in crate::card::sets) static DOORKEEPER: CardRecord = CardRecord::new(
    "Doorkeeper",
    "5c31221f-3753-4d5c-905a-6b558ab648ae",
    "Kev Walker",
    CardRules::new_creature(mana_cost!("{1}{U}"), &["Homunculus"], 0, 4).with_abilities(&[
        abilities::defender(),
        AbilityDef::activated_with_targets(
            "{2}{U}, {T}: Target player mills X where X is the number of \
...
pub(in crate::card::sets) static DOWNSIZE: CardRecord = CardRecord::new(
    "Downsize",
    "e8408a52-d34a-4e03-9312-700dec75d844",
    "Ryan Pancoast",
    CardRules::new_instant(mana_cost!("{U}")).with_abilities(&[
        AbilityDef::spell_with_targets(
...
pub(in crate::card::sets) static FAERIE_IMPOSTOR: CardRecord = CardRecord::new(
    "Faerie Impostor",
    "7dfddc9d-85f6-4b37-9973-14c69f6818ec",
    "Johann Bodin",
...
pub(in crate::card::sets) static HOVER_BARRIER: CardRecord = CardRecord::new(
    "Hover Barrier",
    "884afdb3-0d5f-45a1-b57e-6c3760aa0031",
    "Mathias Kollros",
...
pub(in crate::card::sets) static INACTION_INJUNCTION: CardRecord = CardRecord::new(
    "Inaction Injunction",
    "5342ec3c-9d26-474a-9df5-c21ac90bb233",
    "Wayne Reynolds",
...
const INSPIRATION_REPRINT: PrintingRecord = PrintingRecord::reprint(
    ...
    "e3cf9dc0-0a12-459c-88e2-97ed94653058",
    "Izzy",
);
...
pub(in crate::card::sets) static ISPERIAS_SKYWATCH: CardRecord = CardRecord::new(
    "Isperia's Skywatch",
    "019ba84d-d236-45c5-a8ad-75def7736d0c",
    "Chris Rahn",
...
// Audit: unsupported — Needs controller-driven searches of every player's library followed by
// grouped free casts.
...
const PARALYZING_GRASP_REPRINT: PrintingRecord = PrintingRecord::reprint(
    &crate::card::sets::y2009::zendikar::PARALYZING_GRASP,
    "3dfd97b3-d83e-406f-af45-40eec6347462",
    "Scott Chou",
);
...
pub(in crate::card::sets) static PSYCHIC_SPIRAL: CardRecord = CardRecord::new(
    "Psychic Spiral",
    "59b09c16-f611-4c90-a990-e22bf46bd0e2",
    "Ryan Pancoast",
...
pub(in crate::card::sets) static RUNEWING: CardRecord = CardRecord::new(
    "Runewing",
    "749961e6-b135-4629-ae9d-124de0d70db9",
    "Martina Pilcerova",
...
// Audit: unsupported — Needs source-linked top-card exile, name matching against those and the
// conditional extra-turn continuation.
pub(in crate::card::sets) static SEARCH_THE_CITY: CardRecord = CardRecord::new(
    "Search the City",
    "9cd77575-fedc-45b1-a53b-dfed0f34c875",
    "Jack Wang",
    crate::card::CardRules::unsupported(),
);
...
pub(in crate::card::sets) static SKYLINE_PREDATOR: CardRecord = CardRecord::new(
    "Skyline Predator",
    "5839556c-6635-44c4-96ed-666e4466b929",
    "Wesley Burt",
...
pub(in crate::card::sets) static SOULSWORN_SPIRIT: CardRecord = CardRecord::new(
    "Soulsworn Spirit",
    "32602ed9-c0a7-4498-a333-235eaae628df",
    "James Ryman",
...
// Audit: unsupported — Needs choosing two same-named nonland cards from hand as a single
// activation cost.
pub(in crate::card::sets) static SPHINX_OF_THE_CHIMES: CardRecord = CardRecord::new(
    "Sphinx of the Chimes",
    "31a0cae5-925f-4d00-a4da-1db8bae5511b",
    "Greg Staples",
    crate::card::CardRules::unsupported(),
);
...
pub(in crate::card::sets) static STEALER_OF_SECRETS: CardRecord = CardRecord::new(
    "Stealer of Secrets",
    "30ae7001-4d0f-4160-b41c-2fcb83fdb60b",
    "Michael C. Hayes",
...
const SYNCOPATE_REPRINT: PrintingRecord = PrintingRecord::reprint(
    &crate::card::sets::y2001::odyssey::SYNCOPATE,
    "ba6f218f-83b0-4b68-a00f-0327cd79f32a",
    "Clint Cearley",
);

// RTR 55 — Tower Drake (reprint)
const TOWER_DRAKE_REPRINT: PrintingRecord = PrintingRecord::reprint(
    &crate::card::sets::y2000::invasion::TOWER_DRAKE,
    "5d759d6f-daf0-47f4-8a35-81c9d6437495",
    "Ryan Barger",
);
...
pub(in crate::card::sets) static VOIDWIELDER: CardRecord = CardRecord::new(
    "Voidwielder",
    "23723bc7-a68e-4810-bc87-60df916cbb8a",
    "Chase Stone",
...
pub(in crate::card::sets) static ASSASSINS_STRIKE: CardRecord = CardRecord::new(
    "Assassin's Strike",
    "f796e320-9898-45d4-9d7a-6d35de53c9ab",
    "Chase Stone",
...
const CREMATE_REPRINT: PrintingRecord = PrintingRecord::reprint(
    &crate::card::sets::y2000::invasion::CREMATE,
    "013d5260-f906-4f6a-97ed-725197743b60",
    "Cynthia Sheppard",
);
...
pub(in crate::card::sets) static DAGGERDROME_IMP: CardRecord = CardRecord::new(
    "Daggerdrome Imp",
    "70639887-bdba-4879-a3f8-c716f97fc325",
    "Jack Wang",
...
pub(in crate::card::sets) static DARK_REVENANT: CardRecord = CardRecord::new(
    "Dark Revenant",
    "2167cc6d-ddb5-4f13-8905-a0c5123b852a",
    "Daarken",
...
pub(in crate::card::sets) static DEAD_REVELER: CardRecord = CardRecord::new(
    "Dead Reveler",
    "909a0a38-2c22-4b49-8938-1a8162c077e6",
    "David Palumbo",
...
pub(in crate::card::sets) static DESECRATION_DEMON: CardRecord = CardRecord::new(
    ...
    "Jason Chan",
    CardRules::new_creature(mana_cost!("{2}{B}{B}"), &["Demon"], 6, 6).with_abilities(&[
        abilities::flying(),
        AbilityDef::triggered(
            "At the beginning of each combat, any opponent may sacrifice \
             a creature of their choice. If a player does, tap this \
             creature and put a +1/+1 counter on it.",
...
pub(in crate::card::sets) static DESTROY_THE_EVIDENCE: CardRecord = CardRecord::new(
    ...
    "bca53097-108d-457e-831c-e3d6cb499a41",
    "Clint Cearley",
    CardRules::new_sorcery(mana_cost!("{4}{B}")).with_ability(AbilityDef::spell_with_targets(
        "Destroy target land. Its controller reveals cards from the \
         top of their library until they reveal a land card, then \
...
pub(in crate::card::sets) static DEVIANT_GLEE: CardRecord = CardRecord::new(
    ...
    CardRules::new_enchantment(mana_cost!("{B}"))
        ...
        .with_abilities(&[
            ...
            AbilityDef::static_ability(
                "Enchanted creature gets +2/+1 and has \"{R}: This creature \
                ...
                EffectDef::StaticApply {
                    ...
                    effect: AppliedEffectDef::Composite(&[
                        ...
                        AppliedEffectDef::add_ability(&abilities::apply_to_self_until_end_of_turn(
...
pub(in crate::card::sets) static DRAINPIPE_VERMIN: CardRecord = CardRecord::new(
    "Drainpipe Vermin",
    "4d7251f3-df66-4611-a84c-1897f74431f7",
    "Trevor Claxton",
...
pub(in crate::card::sets) static GRAVE_BETRAYAL: CardRecord = CardRecord::new(
    "Grave Betrayal",
    "47b38c68-8e72-4afc-bb5e-0b40880fdda9",
    "Lucas Graciano",
    CardRules::new_enchantment(mana_cost!("{5}{B}{B}")).with_ability(
        abilities::dies_trigger_matching(
            "Whenever a creature you don't control dies, return it to \
             the battlefield under your control with an additional +1/+1 \
             counter on it at the beginning of the next end step. That \
             creature is a black Zombie in addition to its other colors \
             and types.",
            ObjectPredicateDef::All(&[
                ObjectPredicateDef::HasType(CardType::Creature),
                ...
                then: &EffectDef::InstallTrigger(InstalledTriggerDef::once(
                    &AbilityDef::triggered(
                        "At the beginning of the next end step, return that card to \
                         the battlefield under your control with an additional +1/+1 \
                         counter on it. That creature is a black Zombie in addition \
...
const MIND_ROT_REPRINT: PrintingRecord = PrintingRecord::reprint(
    ...
    "5261ab4b-dfe7-4761-a71c-44a893fc4a69",
    "Yeong-Hao Han",
);
...
pub(in crate::card::sets) static NECROPOLIS_REGENT: CardRecord = CardRecord::new(
    "Necropolis Regent",
    "b421dcc9-0299-416d-86bc-c70ef49bcf98",
    "Winona Nelson",
...
pub(in crate::card::sets) static OGRE_JAILBREAKER: CardRecord = CardRecord::new(
    "Ogre Jailbreaker",
    "9a96c83d-96d9-4f8f-8020-77990130ad81",
    "Karl Kopinski",
...
static RATS_YOU_CONTROL: ValueDef = ValueDef::CountMatchingObjects(&ObjectQueryDef::matching(
    ObjectPredicateDef::Subtype(SubtypeDef::from_name("Rat")),
    &[ZoneKind::Battlefield],
    PlayerRelation::You,
));
...
pub(in crate::card::sets) static PACK_RAT: CardRecord = CardRecord::new(
    "Pack Rat",
    "170693f5-13db-4191-99b1-e527ffb5b88e",
    "Kev Walker",
...
pub(in crate::card::sets) static PERILOUS_SHADOW: CardRecord = CardRecord::new(
    "Perilous Shadow",
    "2c101171-a988-4c1d-9954-634e2f1c6f01",
    "Clint Cearley",
...
pub(in crate::card::sets) static SEWER_SHAMBLER: CardRecord = CardRecord::new(
    "Sewer Shambler",
    "0ae7ba14-c901-4266-ae31-812e001916d3",
    "Nils Hamm",
...
pub(in crate::card::sets) static SHRIEKING_AFFLICTION: CardRecord = CardRecord::new(
    ...
    "dfd08894-2534-4114-9365-40809ba95eb2",
    "Johann Bodin",
    CardRules::new_enchantment(mana_cost!("{B}")).with_ability(AbilityDef::triggered_if(
        "At the beginning of each opponent's upkeep, if that player \
         has one or fewer cards in hand, they lose 3 life.",
        TriggerEventDef::StepBegins {
            step: TurnStepDef::Upkeep,
...
pub(in crate::card::sets) static SLUM_REAPER: CardRecord = CardRecord::new(
    "Slum Reaper",
    "6f0fea13-63cf-4574-8752-3c357eee4524",
    "Karl Kopinski",
...
pub(in crate::card::sets) static STAB_WOUND: CardRecord = CardRecord::new(
    "Stab Wound",
    "7b562269-e6ec-4f8d-844e-26b272248d9d",
    "Scott Chou",
...
pub(in crate::card::sets) static TAVERN_SWINDLER: CardRecord = CardRecord::new(
    "Tavern Swindler",
    "47240ed3-f256-45fb-ab38-7b07e672d2ed",
    "Cynthia Sheppard",
...
pub(in crate::card::sets) static TERRUS_WURM: CardRecord = CardRecord::new(
    ...
    CardRules::new_creature(mana_cost!("{6}{B}"), &["Zombie", "Wurm"], 5, 5).with_abilities(&[
        abilities::scavenge!(
            ...
            "Scavenge {6}{B} ({6}{B}, Exile this card from your \
             graveyard: Put a number of +1/+1 counters equal to this \
             card's power on target creature. Scavenge only as a \
             sorcery.)",
        ),
    ]),
);
...
pub(in crate::card::sets) static THRILL_KILL_ASSASSIN: CardRecord = CardRecord::new(
    ...
    "a9f32204-eda7-4184-92e5-9da8b15b2359",
    "Tyler Jacobson",
...
pub(in crate::card::sets) static ANNIHILATING_FIRE: CardRecord = CardRecord::new(
    "Annihilating Fire",
    "ae12fd10-c13e-4777-a233-96204ec75ac1",
    "Clint Cearley",
    CardRules::new_instant(mana_cost!("{1}{R}{R}")).with_ability(AbilityDef::spell_with_targets(
        "This spell deals 3 damage to any target. If a creature \
...
pub(in crate::card::sets) static ASH_ZEALOT: CardRecord = CardRecord::new(
    "Ash Zealot",
    "1f61b1a3-4b3b-4490-a9dc-17aac258cbda",
    "Eric Deschamps",
    CardRules::new_creature(mana_cost!("{R}{R}"), &["Human", "Warrior"], 2, 2).with_abilities(&[
        abilities::first_strike(),
        abilities::haste(),
        AbilityDef::triggered(
            "Whenever a player casts a spell from a graveyard, this \
...
pub(in crate::card::sets) static BATTERHORN: CardRecord = CardRecord::new(
    "Batterhorn",
    "a7b40f74-893f-4bfc-87b2-7f8df4c912d8",
    "Dave Kendall",
...
pub(in crate::card::sets) static BELLOWS_LIZARD: CardRecord = CardRecord::new(
    "Bellows Lizard",
    "5da4a644-9809-4591-9007-6b70b5f9d923",
    "Jack Wang",
...
pub(in crate::card::sets) static BLOODFRAY_GIANT: CardRecord = CardRecord::new(
    "Bloodfray Giant",
    "a8c468cd-1255-4257-9a69-c6b40a27c427",
    "Steve Argyle",
...
pub(in crate::card::sets) static CHAOS_IMPS: CardRecord = CardRecord::new(
    "Chaos Imps",
    "c70a702a-c9be-4bee-9087-22b5905f783a",
    "Tyler Jacobson",
...
pub(in crate::card::sets) static DYNACHARGE: CardRecord = CardRecord::new(
    "Dynacharge",
    "e612a032-39be-44cd-a78c-29f89dc384b0",
    "Matt Stewart",
...
pub(in crate::card::sets) static ELECTRICKERY: CardRecord = CardRecord::new(
    "Electrickery",
    "5ed81ee8-d5e4-4127-876e-9bff81f9c726",
    "Greg Staples",
    CardRules::new_instant(mana_cost!("{R}")).with_abilities(&[
        AbilityDef::spell_with_targets(
...
pub(in crate::card::sets) static GOBLIN_RALLY: CardRecord = CardRecord::new(
    "Goblin Rally",
    "e4ec8ada-09a6-449a-ac4a-7d3acbd08014",
    "Nic Klein",
    CardRules::new_sorcery(mana_cost!("{3}{R}{R}")).with_ability(AbilityDef::spell(
        "Create four 1/1 red Goblin creature tokens.",
        EffectDef::CreateToken(CreateTokenDef::new(TokenDef::Literal(GOBLIN_TOKEN)).with_amount(4)),
    )),
);
...
pub(in crate::card::sets) static GORE_HOUSE_CHAINWALKER: CardRecord = CardRecord::new(
    ...
    "56ba132f-95fc-4b99-a1dc-ebe6f622bb41",
    "Dan Murayama Scott",
...
pub(in crate::card::sets) static GUILD_FEUD: CardRecord = CardRecord::new(
    "Guild Feud",
    "8e622878-0aea-4401-873e-d34bf05ee98d",
    "Karl Kopinski",
    CardRules::new_enchantment(mana_cost!("{5}{R}")).with_ability(
        AbilityDef::triggered_with_targets(
            "At the beginning of your upkeep, target opponent reveals \
             the top three cards of their library, may put a creature \
             card from among them onto the battlefield, then puts the \
             rest into their graveyard. You do the same with the top \
             three cards of your library. If two creatures are put onto \
             the battlefield this way, those creatures fight each other.",
            TriggerEventDef::StepBegins {
                step: TurnStepDef::Upkeep,
                player: PlayerRelation::You,
            },
...
pub(in crate::card::sets) static GUTTERSNIPE: CardRecord = CardRecord::new(
    "Guttersnipe",
    "9d8590ea-512c-4e09-97cc-7f07d0706f2b",
    "Steve Prescott",
...
pub(in crate::card::sets) static LOBBER_CREW: CardRecord = CardRecord::new(
    "Lobber Crew",
    "b9d4aa15-a3c2-42a3-a87a-443e7dd20c04",
    "Greg Staples",
...
pub(in crate::card::sets) static MINOTAUR_AGGRESSOR: CardRecord = CardRecord::new(
    "Minotaur Aggressor",
    "e22959dc-8759-454e-80b9-623a799af354",
    "Lucas Graciano",
...
pub(in crate::card::sets) static PURSUIT_OF_FLIGHT: CardRecord = CardRecord::new(
    "Pursuit of Flight",
    "37a6290c-a0a8-4032-972b-84a7eef04dae",
    "Christopher Moeller",
    CardRules::new_enchantment(mana_cost!("{1}{R}"))
        ...
        .with_abilities(&[
            ...
            AbilityDef::static_ability(
                "Enchanted creature gets +2/+2 and has \"{U}: This creature \
...
pub(in crate::card::sets) static PYROCONVERGENCE: CardRecord = CardRecord::new(
    "Pyroconvergence",
    "6cff95b7-79eb-4796-9a01-31ff355681ab",
    "Jack Wang",
    CardRules::new_enchantment(mana_cost!("{4}{R}")).with_ability(AbilityDef::triggered_with_targets(
...
pub(in crate::card::sets) static RACECOURSE_FURY: CardRecord = CardRecord::new(
    "Racecourse Fury",
    "15d13d35-b5f7-4d3d-a1fa-84178b28acae",
    "Sam Burley",
...
pub(in crate::card::sets) static SPLATTER_THUG: CardRecord = CardRecord::new(
    "Splatter Thug",
    "7c511805-3392-4033-8679-811711a0aaca",
    "Kev Walker",
...
pub(in crate::card::sets) static STREET_SPASM: CardRecord = CardRecord::new(
    "Street Spasm",
    "9a19d3b8-80d0-480f-8900-47be527d0e53",
    "Raymond Swanland",
...
pub(in crate::card::sets) static SURVEY_THE_WRECKAGE: CardRecord = CardRecord::new(
    "Survey the Wreckage",
    "a6e750f9-ad86-4d60-98a3-78d11cd52cd1",
    "Warren Mahy",
...
const TRAITOROUS_INSTINCT_REPRINT: PrintingRecord = PrintingRecord::reprint(
    &crate::card::sets::y2010::rise_of_the_eldrazi::TRAITOROUS_INSTINCT,
    "d4456951-844a-4847-b933-c32cfafbfef0",
    "Daarken",
);
...
pub(in crate::card::sets) static UTVARA_HELLKITE: CardRecord = CardRecord::new(
    "Utvara Hellkite",
    "f17c6478-dd80-4854-9560-bfc5ef597872",
    "Mark Zug",
        ...
        AbilityDef::triggered(
            ...
            EffectDef::CreateToken(CreateTokenDef::new(TokenDef::Literal(
                TokenCharacteristics::creature(&["Dragon"], &[ManaColor::Red], 6, 6)
                    .with_abilities(&[abilities::flying()])
                    .with_art(CardArt::new(
                        "84310f84-3e5f-4db8-bff1-16bef64de1a0",
                        "Mark Zug",
                    )),
            ))),
        ),
...
pub(in crate::card::sets) static VANDALBLAST: CardRecord = CardRecord::new(
    "Vandalblast",
    "5925c559-3e3c-481b-ba95-20a405cbffce",
    "Seb McKinnon",
...
pub(in crate::card::sets) static AERIAL_PREDATION: CardRecord = CardRecord::new(
    "Aerial Predation",
    "ec3c023c-037e-495a-b7df-32be42a75f36",
    "BD",
...
pub(in crate::card::sets) static AXEBANE_GUARDIAN: CardRecord = CardRecord::new(
    "Axebane Guardian",
    "725584fe-9e97-4020-89b1-5e5b45a5beb2",
    "Slawomir Maniak",
    CardRules::new_creature(mana_cost!("{2}{G}"), &["Human", "Druid"], 0, 3).with_abilities(&[
        abilities::defender(),
        AbilityDef::activated_mana(
            "{T}: Add X mana in any combination of colors, where X is \
...
pub(in crate::card::sets) static CENTAURS_HERALD: CardRecord = CardRecord::new(
    "Centaur's Herald",
    "08598b2b-6fd2-4a1d-8d74-7ca6d93ad382",
    "Howard Lyon",
...
pub(in crate::card::sets) static CHORUS_OF_MIGHT: CardRecord = CardRecord::new(
    ...
    CardRules::new_instant(mana_cost!("{3}{G}")).with_ability(AbilityDef::spell_with_targets(
        ...
        EffectDef::Apply {
            ...
            effect: AppliedEffectDef::Composite(&[
                AppliedEffectDef::modify_power_toughness(
                    ValueDef::CountMatchingObjects(&CHORUS_OF_MIGHT_CREATURES),
                    ValueDef::CountMatchingObjects(&CHORUS_OF_MIGHT_CREATURES),
                ),
                AppliedEffectDef::add_ability(&abilities::trample()),
            ]),
...
pub(in crate::card::sets) static DEATHS_PRESENCE: CardRecord = CardRecord::new(
    "Death's Presence",
    "fa82c57d-4bb9-407c-b973-7abc793b6f47",
    "Ryan Barger",
    // Nothing you lose is wasted: the body moves its power onto whatever is
    // left standing.
    CardRules::new_enchantment(mana_cost!("{5}{G}")).with_ability(
        AbilityDef::triggered_with_targets(
            "Whenever a creature you control dies, put X +1/+1 counters \
             on target creature you control, where X is the power of the \
             creature that died.",
...
pub(in crate::card::sets) static DRUDGE_BEETLE: CardRecord = CardRecord::new(
    "Drudge Beetle",
    "e4812e81-beca-4afc-b2f2-24d5ab27abff",
    "Slawomir Maniak",
    CardRules::new_creature(mana_cost!("{1}{G}"), &["Insect"], 2, 2).with_abilities(&[
        abilities::scavenge!(
            &[CostDef::Mana(mana_cost!("{5}{G}"))],
            "Scavenge {5}{G} ({5}{G}, Exile this card from your \
             graveyard: Put a number of +1/+1 counters equal to this \
             card's power on target creature. Scavenge only as a \
             sorcery.)",
        ),
...
pub(in crate::card::sets) static DRUIDS_DELIVERANCE: CardRecord = CardRecord::new(
    "Druid's Deliverance",
    "83b35961-f4d5-4e14-a793-335147110627",
    "Dan Murayama Scott",
...
const GIANT_GROWTH_REPRINT: PrintingRecord = PrintingRecord::reprint(
    &alpha::GIANT_GROWTH,
    "7b1f6503-e4b2-4085-92cd-e9c522b4b10d",
    "Noah Bradley",
);
...
pub(in crate::card::sets) static GOBBLING_OOZE: CardRecord = CardRecord::new(
    "Gobbling Ooze",
    "465d8a63-0ced-4aec-be34-2098b72c8af6",
    "Johann Bodin",
...
pub(in crate::card::sets) static GOLGARI_DECOY: CardRecord = CardRecord::new(
    "Golgari Decoy",
    "511a42a8-71ce-476f-98fa-fc0dc822edcf",
    "Marco Nelor",
...
pub(in crate::card::sets) static HORNCALLERS_CHANT: CardRecord = CardRecord::new(
    "Horncaller's Chant",
    "7b8d33ed-9ca2-41d1-ba35-fdeb5b88ad44",
    "Eric Velhagen",
...
pub(in crate::card::sets) static MANA_BLOOM: CardRecord = CardRecord::new(
    "Mana Bloom",
    "d7592d88-64e8-4a31-b00a-f65d4b1867fc",
    "Mike Bierek",
    CardRules::new_enchantment(mana_cost!("{X}{G}")).with_abilities(&[
        ...
        AbilityDef::activated_mana(
            "Remove a charge counter from this enchantment: Add one mana \
             of any color. Activate only once each turn.",
        ...
        AbilityDef::triggered_if(
            "At the beginning of your upkeep, if this enchantment has no \
             charge counters on it, return it to its owner's hand.",
            TriggerEventDef::StepBegins {
                step: TurnStepDef::Upkeep,
                player: PlayerRelation::You,
            },
...
pub(in crate::card::sets) static SAVAGE_SURGE: CardRecord = CardRecord::new(
    "Savage Surge",
    "0fa74aae-e857-410c-8836-953c8623d0b0",
    "Svetlin Velinov",
...
const SEEK_THE_HORIZON_REPRINT: PrintingRecord = PrintingRecord::reprint(
    &crate::card::sets::y2005::saviors_of_kamigawa::SEEK_THE_HORIZON,
...
pub(in crate::card::sets) static SLIME_MOLDING: CardRecord = CardRecord::new(
    "Slime Molding",
    "44a439e8-d586-4995-abfc-3dee5c860968",
    "Marco Nelor",
...
pub(in crate::card::sets) static STONEFARE_CROCODILE: CardRecord = CardRecord::new(
    "Stonefare Crocodile",
    "a2517d74-0589-49dc-88f1-1fc02b27bc9d",
    "Tomasz Jedruszek",
...
pub(in crate::card::sets) static WILD_BEASTMASTER: CardRecord = CardRecord::new(
    "Wild Beastmaster",
    "a4d4ef98-949b-49db-b4f9-a070f8b4ff47",
    "Kev Walker",
    CardRules::new_creature(mana_cost!("{2}{G}"), &["Human", "Shaman"], 1, 1).with_ability(
        AbilityDef::triggered(
            "Whenever this creature attacks, each other creature you \
             control gets +X/+X until end of turn, where X is this \
             creature's power.",
            TriggerEventDef::attacks(ObjectPredicateDef::Source),
            EffectDef::Apply {
                recipient: EffectRecipientDef::matching_objects(
...
pub(in crate::card::sets) static WORLDSPINE_WURM: CardRecord = CardRecord::new(
    "Worldspine Wurm",
    "543d55cb-3a6b-4620-af25-10ae74ed32c4",
    "Richard Wright",
    ...
    CardRules::new_creature(mana_cost!("{8}{G}{G}{G}"), &["Wurm"], 15, 15).with_abilities(&[
        abilities::trample(),
        ...
        abilities::dies_trigger(
            "When this creature dies, create three 5/5 green Wurm \
             creature tokens with trample.",
            EffectDef::CreateToken(
                CreateTokenDef::new(TokenDef::Literal(WURM_TOKEN)).with_amount(3),
            ),
        ),
...
pub(in crate::card::sets) static ARMADA_WURM: CardRecord = CardRecord::new(
    "Armada Wurm",
    "50cb4bf3-70d1-4acc-a1fb-49f4ea74ca16",
    "Volkan Baǵa",
    CardRules::new_creature(mana_cost!("{2}{G}{G}{W}{W}"), &["Wurm"], 5, 5).with_abilities(&[
        ...
        abilities::enters_trigger(
            ...
            EffectDef::CreateToken(CreateTokenDef::new(TokenDef::Literal(WURM_TOKEN))),
        ),
    ]),
);
...
pub(in crate::card::sets) static AUGER_SPREE: CardRecord = CardRecord::new(
    "Auger Spree",
    "9580a40b-b413-4f0d-9b38-13903a9d367d",
    "Raymond Swanland",
...
pub(in crate::card::sets) static CALL_OF_THE_CONCLAVE: CardRecord = CardRecord::new(
    ...
    "c6df8f4d-a07a-4664-878d-efec8b2affb9",
    "Terese Nielsen",
...
pub(in crate::card::sets) static CARNIVAL_HELLSTEED: CardRecord = CardRecord::new(
    "Carnival Hellsteed",
    "d8ada7ce-c693-48f0-a6e3-766f61d93370",
    "Chase Stone",
...
pub(in crate::card::sets) static CENTAUR_HEALER: CardRecord = CardRecord::new(
    "Centaur Healer",
    "833835d1-9beb-4ad8-b675-7adebdbd7d82",
    "Mark Zug",
...
pub(in crate::card::sets) static CHEMISTERS_TRICK: CardRecord = CardRecord::new(
    "Chemister's Trick",
    "dbfc2748-351f-4b5d-8a7e-bc51851578bb",
    "Christopher Moeller",
    CardRules::new_instant(mana_cost!("{U}{R}")).with_abilities(&[
        AbilityDef::spell_with_targets(
            "Target creature you don't control gets -2/-0 until end of \
             turn and attacks this turn if able.",
            &[AbilityTargetDef::exactly_one(
                AbilityTargetPredicate::Object {
                    object: ObjectPredicateDef::HasType(CardType::Creature),
                    zones: &[ZoneKind::Battlefield],
        ...
        abilities::overload(
            ...
            "Each creature you don't control gets -2/-0 until end of \
             turn and attacks this turn if able.",
            EffectDef::Apply {
                recipient: EffectRecipientDef::matching_objects(
                    ObjectPredicateDef::HasType(CardType::Creature),
...
pub(in crate::card::sets) static COLLECTIVE_BLESSING: CardRecord = CardRecord::new(
    "Collective Blessing",
    "53c84c4d-e6d6-4eac-9d14-5b6cba914c3d",
    "Svetlin Velinov",
...
pub(in crate::card::sets) static COMMON_BOND: CardRecord = CardRecord::new(
    "Common Bond",
    "59965953-1522-4103-9a6c-5534205d34d9",
    "Raymond Swanland",
...
// Audit: unsupported — Needs a replacement effect that doubles +1/+1 counters placed on
// creatures you control.
pub(in crate::card::sets) static CORPSEJACK_MENACE: CardRecord = CardRecord::new(
    "Corpsejack Menace",
    "b35a8efe-2a3e-4060-9134-d4150e4bdf28",
    "Chris Rahn",
    crate::card::CardRules::unsupported(),
);
    ...
    CardRules::new_enchantment(mana_cost!("{1}{W}{U}")).with_abilities(&[
        abilities::enters_trigger_with_targets(
            "When this enchantment enters, you may exile target nonland \
             permanent not named Detention Sphere and all other \
        ...
        AbilityDef::triggered(
            "When this enchantment leaves the battlefield, return the \
             exiled cards to the battlefield under their owner's control.",
            TriggerEventDef::zone_changed(
                ObjectPredicateDef::Source,
                Some(ZoneKind::Battlefield),
                None,
...
pub(in crate::card::sets) static DRAMATIC_RESCUE: CardRecord = CardRecord::new(
    "Dramatic Rescue",
    "041afd23-1ecc-4cca-9244-fe42203ad689",
    "Ryan Pancoast",
...
pub(in crate::card::sets) static DREADBORE: CardRecord = CardRecord::new(
    "Dreadbore",
    "a83945c6-4dc6-4d9a-9bc2-2d4a264e5422",
    "Wayne Reynolds",
...
pub(in crate::card::sets) static EPIC_EXPERIMENT: CardRecord = CardRecord::new(
    "Epic Experiment",
    "42f0b68a-de4b-4c0c-98ac-a812017f88a7",
    "Dan Murayama Scott",
    CardRules::new_sorcery(mana_cost!("{X}{U}{R}")).with_ability(AbilityDef::spell(
        "Exile the top X cards of your library. You may cast instant \
         and sorcery spells with mana value X or less from among \
         them without paying their mana costs. Then put all cards \
...
pub(in crate::card::sets) static ESSENCE_BACKLASH: CardRecord = CardRecord::new(
    ...
    "Jung Park",
    CardRules::new_instant(mana_cost!("{2}{U}{R}")).with_ability(AbilityDef::spell_with_targets(
        "Counter target creature spell. Essence Backlash deals \
...
pub(in crate::card::sets) static FALL_OF_THE_GAVEL: CardRecord = CardRecord::new(
    "Fall of the Gavel",
    "64f42848-963b-4b16-aeec-66d0f349758b",
    "Matt Stewart",
...
pub(in crate::card::sets) static FIREMIND_S_FORESIGHT: CardRecord = CardRecord::new(
    ...
    "9cb5cb63-e7ec-4fc3-a389-4d8b5a4b96b9",
    "Dan Murayama Scott",
    CardRules::new_instant(mana_cost!("{5}{U}{R}")).with_ability(AbilityDef::spell(
        "Search your library for an instant card with mana value 3, \
         reveal it, and put it into your hand. Then repeat this \
         process for instant cards with mana values 2 and 1. Then \
         shuffle.",
        EffectDef::Sequence(&[
...
pub(in crate::card::sets) static GOBLIN_ELECTROMANCER: CardRecord = CardRecord::new(
    ...
    "79fb620f-4057-4f60-94b9-56ab855be974",
    "Svetlin Velinov",
...
pub(in crate::card::sets) static GOLGARI_CHARM: CardRecord = CardRecord::new(
    "Golgari Charm",
    "48fce388-eefc-4234-8dd9-1260c1ba97eb",
    "Zoltan Boros",
...
pub(in crate::card::sets) static GRISLY_SALVAGE: CardRecord = CardRecord::new(
    ...
    CardRules::new_instant(mana_cost!("{B}{G}")).with_ability(AbilityDef::spell(
        "Reveal the top five cards of your library. You may put a \
         creature or land card from among them into your hand. Put \
...
pub(in crate::card::sets) static HAVOC_FESTIVAL: CardRecord = CardRecord::new(
    "Havoc Festival",
    "04560623-c768-4273-a40d-7e3f39e832cf",
    "Johannes Voss",
    CardRules::new_enchantment(mana_cost!("{4}{B}{R}")).with_abilities(&[
        ...
        AbilityDef::triggered(
            "At the beginning of each player's upkeep, that player loses \
...
const HEROES_REUNION_REPRINT: PrintingRecord = PrintingRecord::reprint(
    &crate::card::sets::y2000::invasion::HEROES_REUNION,
    "99b56515-f688-495c-b721-2b9abc6628c2",
    "Howard Lyon",
);
...
pub(in crate::card::sets) static HUSSAR_PATROL: CardRecord = CardRecord::new(
    "Hussar Patrol",
    "dd775231-e1e0-41e2-ad9a-0726624f57f9",
    "Seb McKinnon",
...
pub(in crate::card::sets) static HYPERSONIC_DRAGON: CardRecord = CardRecord::new(
    "Hypersonic Dragon",
    "f024b19a-923a-4313-be06-e743d3fbab46",
    "Dan Murayama Scott",
...
pub(in crate::card::sets) static ISPERIA_SUPREME_JUDGE: CardRecord = CardRecord::new(
    ...
    "b2cce2d4-3944-4ff0-98e8-80f19697f108",
    "Scott M. Fischer",
...
pub(in crate::card::sets) static IZZET_STATICASTER: CardRecord = CardRecord::new(
    ...
    "Scott M. Fischer",
    CardRules::new_creature(mana_cost!("{1}{U}{R}"), &["Human", "Wizard"], 0, 3).with_abilities(&[
        abilities::flash(),
        abilities::haste(),
        AbilityDef::activated_with_targets(
            "{T}: This creature deals 1 damage to target creature and \
...
// Audit: unsupported — Needs a dynamic creature-card graveyard bonus and sacrifice costs whose
// chosen object's power and land subtypes drive linked effects.
pub(in crate::card::sets) static JARAD_GOLGARI_LICH_LORD: CardRecord = CardRecord::new(
    "Jarad, Golgari Lich Lord",
    "02ef18d1-fd05-4dbc-9fa7-a383799b34e9",
    "Eric Deschamps",
    crate::card::CardRules::unsupported(),
);
...
pub(in crate::card::sets) static JARAD_S_ORDERS: CardRecord = CardRecord::new(
    "Jarad's Orders",
    "c59171ce-7dc6-4dd9-a124-3c2c3028d93d",
    "Svetlin Velinov",
    CardRules::new_sorcery(mana_cost!("{2}{B}{G}")).with_ability(AbilityDef::spell(
        "Search your library for up to two creature cards and reveal \
        ...
        EffectDef::SearchZone {
            ...
            then: Some(&EffectDef::IfNoObjects(IfNoObjectsDef {
                ...
                otherwise: &EffectDef::ChooseCardsFromCollection(ChooseCardsFromCollectionDef {
                    ...
                    then: &EffectDef::Sequence(&[
                        EffectDef::MoveObjects(MoveObjectsDef {
                            input: ObjectSetDef::Binding(Binding!("jarad_orders_graveyard")),
...
pub(in crate::card::sets) static KOROZDA_GUILDMAGE: CardRecord = CardRecord::new(
    "Korozda Guildmage",
    "761c16aa-d4a7-492d-9275-98d0e07de45a",
    "Ryan Pancoast",
    CardRules::new_creature(mana_cost!("{B}{G}"), &["Elf", "Shaman"], 2, 2).with_abilities(&[
        ...
        AbilityDef::activated(
            "{2}{B}{G}, Sacrifice a nontoken creature: Create X 1/1 \
             green Saproling creature tokens, where X is the sacrificed \
...
pub(in crate::card::sets) static LOTLETH_TROLL: CardRecord = CardRecord::new(
    "Lotleth Troll",
    "3b628197-f26c-457a-b9a4-c1f1d3e02f3d",
    "Vincent Proce",
...
pub(in crate::card::sets) static LOXODON_SMITER: CardRecord = CardRecord::new(
    ...
    "Ryan Barger",
    CardRules::new_creature(mana_cost!("{1}{G}{W}"), &["Elephant", "Soldier"], 4, 4)
        .with_abilities(&[
            abilities::cannot_be_countered(),
            AbilityDef::replacement_for(
                "If a spell or ability an opponent controls causes you to \
                 discard this card, put it onto the battlefield instead of \
...
pub(in crate::card::sets) static LYEV_SKYKNIGHT: CardRecord = CardRecord::new(
    "Lyev Skyknight",
    "11cbeb3b-1579-4318-a024-4a2c06896eaf",
    "Johannes Voss",
...
pub(in crate::card::sets) static MERCURIAL_CHEMISTER: CardRecord = CardRecord::new(
    "Mercurial Chemister",
    "881728ce-4b18-410e-9cdb-4d439ce0b21d",
    "Wesley Burt",
    CardRules::new_creature(mana_cost!("{3}{U}{R}"), &["Human", "Wizard"], 2, 3).with_abilities(&[
        ...
        AbilityDef::activated_with_targets(
            "{R}, {T}, Discard a card: This creature deals damage to any \
             target equal to that card's mana value.",
            &[
                CostDef::Mana(mana_cost!("{R}")),
                CostDef::TapSource,
                CostDef::MoveToZone(
            ...
            EffectDef::damage(
                EffectRecipientDef::Target(TargetIndex::PRIMARY),
                ValueDef::ObjectManaValue(ObjectRefDef::Binding(Binding!(
...
pub(in crate::card::sets) static NEW_PRAHV_GUILDMAGE: CardRecord = CardRecord::new(
    "New Prahv Guildmage",
    "698b47d1-c72e-4dc3-b28b-7421e0163f22",
    "Karl Kopinski",
...
pub(in crate::card::sets) static NIVIX_GUILDMAGE: CardRecord = CardRecord::new(
    ...
    CardRules::new_creature(mana_cost!("{U}{R}"), &["Human", "Wizard"], 2, 2).with_abilities(&[
        ...
        AbilityDef::activated_with_targets(
            "{2}{U}{R}: Copy target instant or sorcery spell you \
             control. You may choose new targets for the copy.",
            &[CostDef::Mana(mana_cost!("{2}{U}{R}"))],
            &[AbilityTargetDef::exactly_one(
                AbilityTargetPredicate::Object {
                    object: ObjectPredicateDef::All(&[
                        ObjectPredicateDef::Spell,
...
pub(in crate::card::sets) static NIV_MIZZET_DRACOGENIUS: CardRecord = CardRecord::new(
    ...
    "c345e475-8095-41b5-90b4-771fcf80b939",
    "Todd Lockwood",
...
pub(in crate::card::sets) static RAKDOS_CHARM: CardRecord = CardRecord::new(
    "Rakdos Charm",
    "0fcd4394-d22d-4eec-ad73-ffaf10ad60de",
    "Zoltan Boros",
...
pub(in crate::card::sets) static RAKDOS_RAGEMUTT: CardRecord = CardRecord::new(
    "Rakdos Ragemutt",
    "bb36840a-3f85-4fca-87ab-379dfce8e542",
    "Ryan Barger",
...
pub(in crate::card::sets) static RAKDOS_RINGLEADER: CardRecord = CardRecord::new(
    "Rakdos Ringleader",
    "6b54fbe8-324a-4066-bed1-dda1dca319fc",
    "Jason Felix",
    CardRules::new_creature(mana_cost!("{4}{B}{R}"), &["Skeleton", "Warrior"], 3, 1)
        .with_abilities(&[
            abilities::first_strike(),
            AbilityDef::triggered(
                "Whenever this creature deals combat damage to a player, \
...
// Audit: unsupported — Needs a life-lost-this-turn cast restriction and a global creature-spell
// cost reduction derived from opponents' life loss.
pub(in crate::card::sets) static RAKDOS_LORD_OF_RIOTS: CardRecord = CardRecord::new(
    "Rakdos, Lord of Riots",
    "04f3db71-802f-488c-b40d-ac90df2d660a",
    "Vincent Proce",
    crate::card::CardRules::unsupported(),
);
...
pub(in crate::card::sets) static RAKDOS_S_RETURN: CardRecord = CardRecord::new(
    "Rakdos's Return",
    "d72981c0-1632-4d64-9341-2a76047d9b36",
    "Daarken",
    CardRules::new_sorcery(mana_cost!("{X}{B}{R}")).with_ability(AbilityDef::spell_with_targets(
        "This spell deals X damage to target opponent or \
...
pub(in crate::card::sets) static RIGHTEOUS_AUTHORITY: CardRecord = CardRecord::new(
    "Righteous Authority",
    "6695e5bb-56a9-49ab-8940-72336e845875",
    "Scott Chou",
...
pub(in crate::card::sets) static RITES_OF_REAPING: CardRecord = CardRecord::new(
    "Rites of Reaping",
    "115d504f-3aec-4374-8cd8-732d56c448f2",
    "David Rapoza",
    CardRules::new_sorcery(mana_cost!("{4}{B}{G}")).with_ability(AbilityDef::spell_with_targets(
        "Target creature gets +3/+3 until end of turn. Another \
...
// Audit: unsupported — Its second activation needs a target-player predicate for a player who
// lost life this turn.
pub(in crate::card::sets) static RIX_MAADI_GUILDMAGE: CardRecord = CardRecord::new(
    "Rix Maadi Guildmage",
    "eb737465-5de8-4015-befe-2bf386da2a89",
    "Karl Kopinski",
    crate::card::CardRules::unsupported(),
);
...
pub(in crate::card::sets) static SEARCH_WARRANT: CardRecord = CardRecord::new(
    ...
    CardRules::new_sorcery(mana_cost!("{W}{U}")).with_ability(AbilityDef::spell_with_targets(
        "Target player reveals their hand. You gain life equal to \
...
pub(in crate::card::sets) static SKULL_REND: CardRecord = CardRecord::new(
    "Skull Rend",
    "1c8efb23-bac0-41d2-b4ee-27a6b1fe3134",
    "Greg Staples",
    CardRules::new_sorcery(mana_cost!("{3}{B}{R}")).with_ability(AbilityDef::spell(
        "Skull Rend deals 2 damage to each opponent. Those players \
         each discard two cards at random.",
        EffectDef::Sequence(&[
            EffectDef::damage(EffectRecipientDef::Opponent, ValueDef::Constant(2)),
            EffectDef::Discard {
...
pub(in crate::card::sets) static SKYMARK_ROC: CardRecord = CardRecord::new(
    "Skymark Roc",
    "60601296-2229-4c48-94cc-1903926750ce",
    "Christopher Moeller",
    CardRules::new_creature(mana_cost!("{2}{W}{U}"), &["Bird"], 3, 3).with_abilities(&[
        abilities::flying(),
        AbilityDef::triggered_with_targets(
            "Whenever this creature attacks, you may return target \
             creature defending player controls with toughness 2 or less \
             to its owner's hand.",
            TriggerEventDef::attacks(ObjectPredicateDef::Source),
            &[AbilityTargetDef::exactly_one(
                AbilityTargetPredicate::Object {
...
// Audit: unsupported — Needs a nonland card-name choice and a name-linked search across an
// opponent's graveyard, hand, and library.
pub(in crate::card::sets) static SLAUGHTER_GAMES: CardRecord = CardRecord::new(
    "Slaughter Games",
    "bf37391d-db35-40a7-908a-abb53895793c",
    "Steve Prescott",
    crate::card::CardRules::unsupported(),
);
...
pub(in crate::card::sets) static SLUICEWAY_SCORPION: CardRecord = CardRecord::new(
    "Sluiceway Scorpion",
    "7b6dbadf-a6f7-4876-9c3f-44e4a33b2bee",
    "Slawomir Maniak",
    CardRules::new_creature(mana_cost!("{2}{B}{G}"), &["Scorpion"], 2, 2).with_abilities(&[
        abilities::deathtouch(),
        abilities::scavenge!(
            &[CostDef::Mana(mana_cost!("{1}{B}{G}"))],
            "Scavenge {1}{B}{G} ({1}{B}{G}, Exile this card from your \
             graveyard: Put a number of +1/+1 counters equal to this \
             card's power on target creature. Scavenge only as a \
             sorcery.)",
        ),
...
pub(in crate::card::sets) static SPAWN_OF_RIX_MAADI: CardRecord = CardRecord::new(
    "Spawn of Rix Maadi",
    "6196e702-7f76-49db-8ee4-bd343359d498",
    "Min Yum",
...
pub(in crate::card::sets) static TELEPORTAL: CardRecord = CardRecord::new(
    "Teleportal",
    "e438c718-ac18-45d5-824e-5b697c5f0692",
    "Scott M. Fischer",
    CardRules::new_sorcery(mana_cost!("{U}{R}")).with_abilities(&[
        ...
        abilities::overload(
            &[CostDef::Mana(mana_cost!("{3}{U}{R}"))],
            "Each creature you control gets +1/+0 until end of turn and \
...
pub(in crate::card::sets) static THOUGHTFLARE: CardRecord = CardRecord::new(
    "Thoughtflare",
    "d90514aa-e356-4502-9e0e-76ab7644a07a",
    "David Rapoza",
...
pub(in crate::card::sets) static TREASURED_FIND: CardRecord = CardRecord::new(
    "Treasured Find",
    "a2c0e00b-2290-493f-a3fc-3b9bff2830cc",
    "Jason Chan",
...
pub(in crate::card::sets) static TRESTLE_TROLL: CardRecord = CardRecord::new(
    "Trestle Troll",
    "6d224279-83f3-4a29-9fd9-86b72407b87a",
    "Peter Mohrbacher",
...
pub(in crate::card::sets) static TROSTANI_SELESNYAS_VOICE: CardRecord = CardRecord::new(
    ...
    "9d1d9d86-5666-4e59-9766-137657b4e040",
    "Chippy",
    CardRules::new_creature(mana_cost!("{G}{G}{W}{W}"), &["Dryad"], 2, 5)
        ...
        .with_abilities(&[
            ...
            AbilityDef::activated(
                "{1}{G}{W}, {T}: Populate.",
                &[CostDef::Mana(mana_cost!("{1}{G}{W}")), CostDef::TapSource],
                abilities::populate(),
            ),
        ]),
);
...
pub(in crate::card::sets) static VITU_GHAZI_GUILDMAGE: CardRecord = CardRecord::new(
    ...
    "e54f8e61-550f-4493-b8ba-65f81b2457d3",
    "Jason Chan",
            ...
            AbilityDef::activated(
                ...
                EffectDef::Apply {
                    ...
                    effect: AppliedEffectDef::add_ability(&AbilityDef::triggered(
                        ...
                        TriggerEventDef::combat_damage_to_source(ObjectPredicateDef::HasType(
                            CardType::Creature,
                        )),
                        EffectDef::Destroy {
                            object: EffectRecipientDef::TriggeringObject,
...
pub(in crate::card::sets) static WAYFARING_TEMPLE: CardRecord = CardRecord::new(
    "Wayfaring Temple",
    "2125e6aa-f916-4dfa-a9fe-82bb546012af",
    "Peter Mohrbacher",
...
pub(in crate::card::sets) static AZOR_S_ELOCUTORS: CardRecord = CardRecord::new(
    "Azor's Elocutors",
    "61e82934-546b-4734-a715-b22ace4c5a9b",
    "Johannes Voss",
    CardRules::new_creature(mana_cost!("{3}{W/U}{W/U}"), &["Human", "Advisor"], 3, 5)
        .with_abilities(&[
            AbilityDef::triggered(
                "At the beginning of your upkeep, put a filibuster counter \
                 on this creature. Then if this creature has five or more \
...
pub(in crate::card::sets) static BLISTERCOIL_WEIRD: CardRecord = CardRecord::new(
    "Blistercoil Weird",
    "d2a8e716-ea33-4ae2-9ff8-5e78b0e50459",
    "Dan Murayama Scott",
...
// Audit: unsupported — Needs the total life lost by all opponents this turn as a dynamic
// enters-with-counter replacement value.
pub(in crate::card::sets) static CRYPTBORN_HORROR: CardRecord = CardRecord::new(
    "Cryptborn Horror",
    "8ffd77d7-3fe6-4493-96eb-f62183c0358d",
    "Richard Wright",
    crate::card::CardRules::unsupported(),
);
...
pub(in crate::card::sets) static DEATHRITE_SHAMAN: CardRecord = CardRecord::new(
    "Deathrite Shaman",
    "70496f16-c4c0-4c03-beef-454eb4824cd1",
    "Steve Argyle",
...
// Audit: unsupported — Needs external graveyard-move replacements to inspect the moving card's
// types from every source zone; the current external replacement matcher only receives owner
// and token status.
...
pub(in crate::card::sets) static FROSTBURN_WEIRD: CardRecord = CardRecord::new(
    "Frostburn Weird",
    "ba5a68d3-6bc9-4de8-bc06-e1106cf9b3d4",
    "Mike Bierek",
...
pub(in crate::card::sets) static GROWING_RANKS: CardRecord = CardRecord::new(
    "Growing Ranks",
    "12f31616-1249-4964-b81a-4435405a2449",
    "Seb McKinnon",
...
pub(in crate::card::sets) static JUDGES_FAMILIAR: CardRecord = CardRecord::new(
    "Judge's Familiar",
    "0fc51899-3970-416b-b7de-fadbc9678955",
    "Jack Wang",
    CardRules::new_creature(mana_cost!("{W/U}"), &["Bird"], 1, 1).with_abilities(&[
        abilities::flying(),
        AbilityDef::activated_with_targets(
            "Sacrifice this creature: Counter target instant or sorcery \
...
// Audit: unsupported — Needs exiling a chosen instant or sorcery spell you control from the
// stack as an activation cost.
pub(in crate::card::sets) static NIVMAGUS_ELEMENTAL: CardRecord = CardRecord::new(
    "Nivmagus Elemental",
    "b1892003-2e4c-43bd-8a37-3a97a76f113a",
    "Mike Bierek",
    crate::card::CardRules::unsupported(),
);
...
pub(in crate::card::sets) static RAKDOS_CACKLER: CardRecord = CardRecord::new(
    "Rakdos Cackler",
    "5f873c0b-e779-4f09-8e9c-94a1765eb5da",
    "Ryan Barger",
...
pub(in crate::card::sets) static SLITHERHEAD: CardRecord = CardRecord::new(
    "Slitherhead",
    "d9327905-a254-4885-8310-69fc153ec52f",
    "Greg Staples",
    CardRules::new_creature(mana_cost!("{B/G}"), &["Plant", "Zombie"], 1, 1).with_abilities(&[
        abilities::scavenge!(
            &[CostDef::Mana(mana_cost!("{0}"))],
            "Scavenge {0} ({0}, Exile this card from your graveyard: Put \
             a number of +1/+1 counters equal to this card's power on \
...
pub(in crate::card::sets) static SUNDERING_GROWTH: CardRecord = CardRecord::new(
    "Sundering Growth",
    "14d5048e-cb76-48c4-8a95-70dcc14775f6",
    "David Palumbo",
...
pub(in crate::card::sets) static AZORIUS_KEYRUNE: CardRecord = CardRecord::new(
    "Azorius Keyrune",
    "23a05db7-dcae-4180-8ad1-60ba6fb30816",
    "Daniel Ljunggren",
    CardRules::new_artifact(mana_cost!("{3}")).with_abilities(&[
        ...
        AbilityDef::activated(
            "{W}{U}: This artifact becomes a 2/2 white and blue Bird \
...
pub(in crate::card::sets) static CHROMATIC_LANTERN: CardRecord = CardRecord::new(
    "Chromatic Lantern",
    "57f4e0f0-13d1-43ed-8d95-13cff94a26e7",
    "Jung Park",
    CardRules::new_artifact(mana_cost!("{3}")).with_abilities(&[
        AbilityDef::static_ability(
...
pub(in crate::card::sets) static CIVIC_SABER: CardRecord = CardRecord::new(
    "Civic Saber",
    "29c9247e-05f4-44bb-86e3-90a60e880374",
    "Jung Park",
...
pub(in crate::card::sets) static CODEX_SHREDDER: CardRecord = CardRecord::new(
    "Codex Shredder",
    "8f7b632b-ee20-4082-8376-1dae53f91b70",
    "Jason Felix",
    CardRules::new_artifact(mana_cost!("{1}")).with_abilities(&[
        ...
        AbilityDef::activated_with_targets(
            "{5}, {T}, Sacrifice this artifact: Return target card from \
...
pub(in crate::card::sets) static GOLGARI_KEYRUNE: CardRecord = CardRecord::new(
    "Golgari Keyrune",
    "913b803f-ba82-4660-86be-49677d1e32c9",
    "Daniel Ljunggren",
    CardRules::new_artifact(mana_cost!("{3}")).with_abilities(&[
        AbilityDef::activated_mana(
            "{T}: Add {B} or {G}.",
        ...
        AbilityDef::activated(
            "{B}{G}: This artifact becomes a 2/2 black and green Insect \
             artifact creature with deathtouch until end of turn.",
...
pub(in crate::card::sets) static IZZET_KEYRUNE: CardRecord = CardRecord::new(
    "Izzet Keyrune",
    "83e4e83b-cbb8-4efd-b6c4-4459a29177ac",
    "Daniel Ljunggren",
    CardRules::new_artifact(mana_cost!("{3}")).with_abilities(&[
        AbilityDef::activated_mana(
            "{T}: Add {U} or {R}.",
        ...
        AbilityDef::activated(
            "{U}{R}: Until end of turn, this artifact becomes a 2/1 blue \
             and red Elemental artifact creature.",
            &[CostDef::Mana(mana_cost!("{U}{R}"))],
            EffectDef::Apply {
                recipient: EffectRecipientDef::Source,
        ...
        AbilityDef::triggered(
            "Whenever this artifact deals combat damage to a player, you \
...
const PITHING_NEEDLE_REPRINT: PrintingRecord = PrintingRecord::reprint(
    &crate::card::sets::y2005::saviors_of_kamigawa::PITHING_NEEDLE,
...
pub(in crate::card::sets) static RAKDOS_KEYRUNE: CardRecord = CardRecord::new(
    "Rakdos Keyrune",
    "f6124b4c-49a1-42e3-a6ff-62de231c7823",
    "Daniel Ljunggren",
    CardRules::new_artifact(mana_cost!("{3}")).with_abilities(&[
        AbilityDef::activated_mana(
            "{T}: Add {B} or {R}.",
        ...
        AbilityDef::activated(
            "{B}{R}: This artifact becomes a 3/1 black and red Devil \
             artifact creature with first strike until end of turn.",
...
pub(in crate::card::sets) static SELESNYA_KEYRUNE: CardRecord = CardRecord::new(
    "Selesnya Keyrune",
    "1645eafd-cd17-463a-9d7e-42f5f7b5196f",
    "Daniel Ljunggren",
    CardRules::new_artifact(mana_cost!("{3}")).with_abilities(&[
        AbilityDef::activated_mana(
            "{T}: Add {G} or {W}.",
        ...
        AbilityDef::activated(
            "{G}{W}: This artifact becomes a 3/3 green and white Wolf \
...
// Audit: unsupported — Needs selecting and destroying every Aura attached to the targeted land
// through an attachment-relationship predicate.
pub(in crate::card::sets) static STREET_SWEEPER: CardRecord = CardRecord::new(
    "Street Sweeper",
    "4a62827a-183f-4bef-b6ce-20a4577f6d30",
    "Izzy",
    crate::card::CardRules::unsupported(),
);
...
pub(in crate::card::sets) static VOLATILE_RIG: CardRecord = CardRecord::new(
    "Volatile Rig",
    "5055ed18-b234-4702-92eb-4d483431ff47",
    "Mathias Kollros",
    CardRules::new_artifact_creature(mana_cost!("{4}"), &["Construct"], 4, 4).with_abilities(&[
        abilities::trample(),
        abilities::attacks_each_combat_if_able(),
        AbilityDef::triggered(
            "Whenever this creature is dealt damage, flip a coin. If you \
        ...
        abilities::dies_trigger(
            "When this creature dies, flip a coin. If you lose the flip, \
             it deals 4 damage to each creature and each player.",
            EffectDef::FlipCoin {
                on_win: &EffectDef::None,
                on_loss: &EffectDef::damage_simultaneously(&[
...
pub(in crate::card::sets) static AZORIUS_GUILDGATE: CardRecord = CardRecord::new(
    "Azorius Guildgate",
    "984e37df-0734-493a-a958-f519a0c98580",
    "Drew Baker",
...
const BLOOD_CRYPT_REPRINT: PrintingRecord = PrintingRecord::reprint(
    &crate::card::sets::y2006::dissension::BLOOD_CRYPT,
    "8bd5828b-8dcd-4ce6-b834-ebe9cbaa12d1",
    "Vincent Proce",
);
...
pub(in crate::card::sets) static GROVE_OF_THE_GUARDIAN: CardRecord = CardRecord::new(
    ...
    "3cf60ca0-e01f-499c-8d04-d59050f38c33",
    "Christine Choi",
    CardRules::unsupported(),
);
...
const HALLOWED_FOUNTAIN_REPRINT: PrintingRecord = PrintingRecord::reprint(
    &crate::card::sets::y2006::dissension::HALLOWED_FOUNTAIN,
...
pub(in crate::card::sets) static IZZET_GUILDGATE: CardRecord = CardRecord::new(
    "Izzet Guildgate",
    "6951d84f-2d3c-4203-8d31-e08f4bc707f0",
    "Noah Bradley",
    CardRules::new_land(&["Gate"]).with_abilities(&[
        abilities::enters_tapped(CardType::Land),
        AbilityDef::activated_mana(
...
const OVERGROWN_TOMB_REPRINT: PrintingRecord = PrintingRecord::reprint(
    &crate::card::sets::y2005::ravnica_city_of_guilds::OVERGROWN_TOMB,
...
pub(in crate::card::sets) static RAKDOS_GUILDGATE: CardRecord = CardRecord::new(
    "Rakdos Guildgate",
    "207048f5-268b-4cdb-b4e7-c8282cac1b28",
    "Eytan Zana",
    CardRules::new_land(&["Gate"]).with_abilities(&[
        abilities::enters_tapped(CardType::Land),
        AbilityDef::activated_mana(
...
pub(in crate::card::sets) static ROGUES_PASSAGE: CardRecord = CardRecord::new(
    "Rogue's Passage",
    "f416e36a-15cb-43c8-b27f-82f65a95ddef",
    "Christine Choi",
...
pub(in crate::card::sets) static SELESNYA_GUILDGATE: CardRecord = CardRecord::new(
    "Selesnya Guildgate",
    "ff61d4e4-3c8c-48f7-a994-ec2317bbd9a0",
    "Howard Lyon",
    CardRules::new_land(&["Gate"]).with_abilities(&[
        abilities::enters_tapped(CardType::Land),
        AbilityDef::activated_mana(
...
const STEAM_VENTS_REPRINT: PrintingRecord = PrintingRecord::reprint(
    &crate::card::sets::y2006::guildpact::STEAM_VENTS,
...
const TEMPLE_GARDEN_REPRINT: PrintingRecord = PrintingRecord::reprint(
    &crate::card::sets::y2005::ravnica_city_of_guilds::TEMPLE_GARDEN,
...
pub(in crate::card::sets) static TRANSGUILD_PROMENADE: CardRecord = CardRecord::new(
    ...
    "90ce8115-41fe-44c2-8719-741ba87bcb17",
    "Noah Bradley",
    CardRules::new_land(&[]).with_abilities(&[
        abilities::enters_tapped(CardType::Land),
        abilities::enters_trigger(
...
const PLAINS_REPRINT: PrintingRecord = PrintingRecord::reprint(
    &alpha::PLAINS,
    "ac754820-343e-4c01-bcfa-89fa5c8c7e1d",
    "John Avon",
);
...
const PLAINS_ALTERNATE_1: PrintingRecord = PrintingRecord::alternate(
    &alpha::PLAINS,
    1,
    "34044cf5-79ed-479c-abdc-3718ec193dd3",
    "Yeong-Hao Han",
);
...
const PLAINS_ALTERNATE_2: PrintingRecord = PrintingRecord::alternate(
    &alpha::PLAINS,
    2,
    "b0b9bcca-b41a-4a6a-b380-36bfea9f0715",
    "Adam Paquette",
);
...
const PLAINS_ALTERNATE_3: PrintingRecord = PrintingRecord::alternate(
    &alpha::PLAINS,
    3,
    "d293ea0f-8b87-4d8a-ad8f-650131c83c20",
    "Richard Wright",
);
...
const PLAINS_ALTERNATE_4: PrintingRecord = PrintingRecord::alternate(
    &alpha::PLAINS,
    4,
    "be0334fe-3de3-4779-a31d-d021db50b62b",
    "Richard Wright",
);
...
const ISLAND_REPRINT: PrintingRecord = PrintingRecord::reprint(
    &alpha::ISLAND,
    "78f35064-c662-48ff-a2a9-d26f594500f5",
    "John Avon",
);
...
const ISLAND_ALTERNATE_1: PrintingRecord = PrintingRecord::alternate(
    &alpha::ISLAND,
    1,
    "8dc5e0d9-1c8f-4d38-9915-40469988983d",
    "Yeong-Hao Han",
);
...
const ISLAND_ALTERNATE_2: PrintingRecord = PrintingRecord::alternate(
    &alpha::ISLAND,
    2,
    "f10e5b17-6099-445d-9a7b-484eeff7cea8",
    "Adam Paquette",
);
...
const ISLAND_ALTERNATE_3: PrintingRecord = PrintingRecord::alternate(
    &alpha::ISLAND,
    3,
    "7869f14e-d1d5-4a99-bc2c-f3a0d63077a5",
    "Richard Wright",
);
...
const ISLAND_ALTERNATE_4: PrintingRecord = PrintingRecord::alternate(
    &alpha::ISLAND,
    4,
    "e070e97c-142a-4d5d-ae89-c0c6d85a97ac",
    "Richard Wright",
);
...
const SWAMP_REPRINT: PrintingRecord = PrintingRecord::reprint(
    &alpha::SWAMP,
    "2d8c3f29-121e-42d1-be21-29f403f97708",
    "John Avon",
);
...
const SWAMP_ALTERNATE_1: PrintingRecord = PrintingRecord::alternate(
    &alpha::SWAMP,
    1,
    "be73b50e-8230-41e5-8492-db8f749d00a4",
    "Yeong-Hao Han",
);
...
const SWAMP_ALTERNATE_2: PrintingRecord = PrintingRecord::alternate(
    &alpha::SWAMP,
    2,
    "46908606-f572-4b2d-9562-ed9c6f50f1ad",
    "Adam Paquette",
);
...
const SWAMP_ALTERNATE_3: PrintingRecord = PrintingRecord::alternate(
    &alpha::SWAMP,
    3,
    "f7cd375e-f41c-42b1-bbd4-36032d4fb92d",
    "Richard Wright",
);
...
const SWAMP_ALTERNATE_4: PrintingRecord = PrintingRecord::alternate(
    &alpha::SWAMP,
    4,
    "745b1731-af31-44d2-ad50-b3e43b620913",
    "Richard Wright",
);
...
const MOUNTAIN_REPRINT: PrintingRecord = PrintingRecord::reprint(
    &alpha::MOUNTAIN,
    "3b4a196f-de7e-4100-ad65-56cf8b0a8b23",
    "John Avon",
);
...
const MOUNTAIN_ALTERNATE_1: PrintingRecord = PrintingRecord::alternate(
    &alpha::MOUNTAIN,
    1,
    "a5b2d0ed-0b47-459a-8f5c-554dd816c03a",
    "Yeong-Hao Han",
);
...
const MOUNTAIN_ALTERNATE_2: PrintingRecord = PrintingRecord::alternate(
    &alpha::MOUNTAIN,
    2,
    "5353e8b2-3280-48ec-9bc2-8c8e7a15b460",
    "Adam Paquette",
);
...
const MOUNTAIN_ALTERNATE_3: PrintingRecord = PrintingRecord::alternate(
    &alpha::MOUNTAIN,
    3,
    "24b61852-860e-4f89-a1b2-6429168f0c02",
    "Richard Wright",
);
...
const MOUNTAIN_ALTERNATE_4: PrintingRecord = PrintingRecord::alternate(
    &alpha::MOUNTAIN,
    4,
    "96614dc1-9386-4861-b792-b83bcc6c5811",
    "Richard Wright",
);
...
const FOREST_REPRINT: PrintingRecord = PrintingRecord::reprint(
    &alpha::FOREST,
    "f00849dd-c1ba-4171-a503-603fe77c0a43",
    "John Avon",
);
...
const FOREST_ALTERNATE_1: PrintingRecord = PrintingRecord::alternate(
    &alpha::FOREST,
    1,
    "1428575c-f18e-41a0-b58a-259d2feafd06",
    "Yeong-Hao Han",
);
...
const FOREST_ALTERNATE_2: PrintingRecord = PrintingRecord::alternate(
    &alpha::FOREST,
    2,
    "e6850740-6219-4f82-a705-2e7b20ede751",
    "Adam Paquette",
);
...
const FOREST_ALTERNATE_3: PrintingRecord = PrintingRecord::alternate(
    &alpha::FOREST,
    3,
    "edc50993-1fd4-4dba-9d2f-ae7a18559829",
    "Richard Wright",
);
...
const FOREST_ALTERNATE_4: PrintingRecord = PrintingRecord::alternate(
    &alpha::FOREST,
    4,
    "ddfcde62-1b20-48ce-8ba0-7929edcd26fc",
    "Richard Wright",
);
