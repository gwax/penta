...
pub(in crate::card::sets) static ALLAY: CardRecord = CardRecord::new(
    "Allay",
    "f20a1c6d-ec6a-4bd6-b3b2-b997f71d41fc",
    "Randy Gallegos",
...
const ANGELIC_BLESSING_REPRINT: PrintingRecord = PrintingRecord::reprint(
    &crate::card::sets::y1997::portal::ANGELIC_BLESSING,
    "ed3c8bae-953f-4bb4-a78d-02e4e354e53c",
    "Mark Zug",
);
...
pub(in crate::card::sets) static CATACLYSM: CardRecord = CardRecord::new(
    "Cataclysm",
    "024ae668-a1ae-4020-89c8-acbd8bd0a691",
    "Jim Nelson",
    crate::card::CardRules::unsupported(),
);

// EXO 4 — Charging Paladin (reprint)
const CHARGING_PALADIN_REPRINT: PrintingRecord = PrintingRecord::reprint(
    &crate::card::sets::y1997::portal::CHARGING_PALADIN,
    "851f3f72-2923-4432-898a-02679a8b320f",
    "Ciruelo",
);
...
pub(in crate::card::sets) static EXALTED_DRAGON: CardRecord = CardRecord::new(
    "Exalted Dragon",
    "7537bab3-4bac-4b83-9ad3-dfcb4ff19d6d",
    "Matthew D. Wilson",
    crate::card::CardRules::unsupported(),
);
...
pub(in crate::card::sets) static HIGH_GROUND: CardRecord = CardRecord::new(
    "High Ground",
    "1c5239dc-f51b-48c0-91a2-ed6551aaff32",
    "rk post",
...
pub(in crate::card::sets) static KOR_CHANT: CardRecord = CardRecord::new(
    "Kor Chant",
    "8dc61cc3-0312-44f4-9c23-4fc37c3fbbd5",
    "John Matson",
    crate::card::CardRules::unsupported(),
);
...
pub(in crate::card::sets) static LIMITED_RESOURCES: CardRecord = CardRecord::new(
    "Limited Resources",
    "20ae3609-a3cc-486c-94f6-b8f647adfb47",
    "Keith Parkinson",
    CardRules::new_enchantment(mana_cost!("{W}")).with_abilities(&[
        abilities::enters_trigger(
            "When this enchantment enters, each player chooses five \
            ...
            EffectDef::ChooseForEachPlayer(ChooseForEachPlayerDef {
                ...
                then: &EffectDef::sacrifice(EffectRecipientDef::objects(ObjectSetDef::Binding(
                    Binding!("limited_resources_lands_sacrificed"),
                ))),
            }),
        ),
...
pub(in crate::card::sets) static OATH_OF_LIEGES: CardRecord = CardRecord::new(
    "Oath of Lieges",
    "470a2092-eeda-4557-8cee-ac401b61a225",
    "Mark Zug",
    CardRules::new_enchantment(mana_cost!("{1}{W}")).with_ability(
        AbilityDef::triggered_with_targets(
            "At the beginning of each player's upkeep, that player \
             chooses target player who controls more lands than they do \
             and is their opponent. The first player may search their \
...
pub(in crate::card::sets) static PALADIN_EN_VEC: CardRecord = CardRecord::new(
    "Paladin en-Vec",
    "bf1ea89d-4b9d-455f-a7f4-a26026e0c272",
    "Randy Elliott",
...
pub(in crate::card::sets) static PEACE_OF_MIND: CardRecord = CardRecord::new(
    "Peace of Mind",
    "c383f12f-da06-4ef0-bf8e-6a8a9cfcc74c",
    "Randy Elliott",
...
pub(in crate::card::sets) static PEGASUS_STAMPEDE: CardRecord = CardRecord::new(
    "Pegasus Stampede",
    "3b941576-8254-4d69-85ae-c748c7921ce5",
    "Mark Zug",
    CardRules::new_sorcery(mana_cost!("{1}{W}")).with_abilities(&[
        ...
        .override_text(
            "Buyback—Sacrifice a land. (You may sacrifice a land in \
             addition to any other costs as you cast this spell. If you \
...
pub(in crate::card::sets) static PENANCE: CardRecord = CardRecord::new(
    "Penance",
    "1f3db848-8394-43bd-a236-264641033a6d",
    "Terese Nielsen",
...
pub(in crate::card::sets) static REAPING_THE_REWARDS: CardRecord = CardRecord::new(
    "Reaping the Rewards",
    "379b0495-8795-4b21-9d0a-dc4e10098de2",
    "Heather Hudson",
...
pub(in crate::card::sets) static RECONNAISSANCE: CardRecord = CardRecord::new(
    "Reconnaissance",
    "a16012d8-703c-4385-8769-13e3caba3fc6",
    "Val Mayerik",
...
pub(in crate::card::sets) static SHACKLES: CardRecord = CardRecord::new(
    "Shackles",
    "c5315668-b8ef-49ab-a8f5-144adc7bcd84",
    "Heather Hudson",
...
pub(in crate::card::sets) static SHIELD_MATE: CardRecord = CardRecord::new(
    "Shield Mate",
    "b49261bb-66b5-4226-9001-02d045fbcbce",
    "Randy Elliott",
...
pub(in crate::card::sets) static SOLTARI_VISIONARY: CardRecord = CardRecord::new(
    "Soltari Visionary",
    "1a3ae384-7b60-4264-9dc1-1613917168ca",
    "Adam Rex",
    CardRules::new_creature(mana_cost!("{1}{W}{W}"), &["Soltari", "Cleric"], 2, 2).with_abilities(
        &[
            abilities::shadow(),
            AbilityDef::triggered_with_targets(
                "Whenever this creature deals damage to a player, destroy \
                 target enchantment that player controls.",
...
pub(in crate::card::sets) static SOUL_WARDEN: CardRecord = CardRecord::new(
    "Soul Warden",
    "d5ee24ee-4d28-4634-bd43-90eff15c16dd",
    "Randy Gallegos",
...
pub(in crate::card::sets) static STANDING_TROOPS: CardRecord = CardRecord::new(
    "Standing Troops",
    "135e258a-71d8-45dd-9307-91111aa34bde",
    "Daren Bader",
...
pub(in crate::card::sets) static TREASURE_HUNTER: CardRecord = CardRecord::new(
    "Treasure Hunter",
    "06452630-621b-498e-8f25-ecfe544d4213",
    "Adam Rex",
    CardRules::new_creature(mana_cost!("{2}{W}"), &["Human"], 2, 2).with_ability(
        abilities::enters_trigger_with_targets(
            "When this creature enters, you may return target artifact \
...
pub(in crate::card::sets) static WALL_OF_NETS: CardRecord = CardRecord::new(
    "Wall of Nets",
    "c1da8e79-365d-4a36-87c5-648085828f9f",
    "Terese Nielsen",
    CardRules::new_creature(mana_cost!("{1}{W}{W}"), &["Wall"], 0, 7).with_abilities(&[
        ...
        AbilityDef::triggered(
            "When this creature leaves the battlefield, return all cards \
             exiled with it to the battlefield under their owners' \
             control.",
            TriggerEventDef::zone_changed(
...
pub(in crate::card::sets) static WELKIN_HAWK: CardRecord = CardRecord::new(
    "Welkin Hawk",
    "8166253c-c6ac-4b5e-9746-09ce3774c66b",
    "Rob Alexander",
    CardRules::new_creature(mana_cost!("{1}{W}"), &["Bird"], 1, 1).with_abilities(&[
        abilities::flying(),
        abilities::dies_trigger(
            "When this creature dies, you may search your library for a \
...
pub(in crate::card::sets) static ZEALOTS_EN_DAL: CardRecord = CardRecord::new(
    "Zealots en-Dal",
    "6a9fb486-1d6a-478e-af6e-fd8539dc646d",
    "Brom",
    CardRules::new_creature(mana_cost!("{3}{W}"), &["Human", "Soldier"], 2, 4).with_ability(
        AbilityDef::triggered_if(
            "At the beginning of your upkeep, if all nonland permanents \
             you control are white, you gain 1 life.",
            TriggerEventDef::StepBegins {
                step: TurnStepDef::Upkeep,
                player: PlayerRelation::You,
            },
...
pub(in crate::card::sets) static AETHER_TIDE: CardRecord = CardRecord::new(
    ...
    CardRules::new_sorcery(mana_cost!("{X}{U}")).with_ability(
        AbilityDef::spell_with_additional_cost(
            "As an additional cost to cast this spell, discard X \
             creature cards.\nReturn X target creatures to their owners' \
             hands.",
            ...
            CostDef::discard(ObjectPredicateDef::HasType(CardType::Creature))
                .with_quantity(CostQuantityDef::ChosenX),
            EffectDef::move_to_zone(
                EffectRecipientDef::Target(TargetIndex::PRIMARY),
                ZoneKind::Hand,
                ZonePlacement::Top,
...
pub(in crate::card::sets) static CUNNING: CardRecord = CardRecord::new(
    "Cunning",
    "52f36bb8-5a97-4596-8ca3-707665770c76",
    "Kev Walker",
    crate::card::CardRules::unsupported(),
);
...
pub(in crate::card::sets) static CURIOSITY: CardRecord = CardRecord::new(
    "Curiosity",
    "fee17ef5-7e1a-42ae-b680-df81204df7dd",
    "Val Mayerik",
...
pub(in crate::card::sets) static EPHEMERON: CardRecord = CardRecord::new(
    "Ephemeron",
    "f2cdcd3b-6df5-481a-a244-1fc2545d1356",
    "Keith Parkinson",
...
pub(in crate::card::sets) static EQUILIBRIUM: CardRecord = CardRecord::new(
    "Equilibrium",
    "460b2ec6-0180-4214-acca-c9eed778ef50",
    "Jeff Miracola",
    CardRules::new_enchantment(mana_cost!("{1}{U}{U}")).with_ability(
        AbilityDef::triggered_with_targets(
            "Whenever you cast a creature spell, you may pay {1}. If you \
             do, return target creature to its owner's hand.",
...
pub(in crate::card::sets) static ERTAI_WIZARD_ADEPT: CardRecord = CardRecord::new(
    "Ertai, Wizard Adept",
    "91971e19-61ce-45ac-b700-9ffca5091a27",
    "Terese Nielsen",
...
pub(in crate::card::sets) static FADE_AWAY: CardRecord = CardRecord::new(
    "Fade Away",
    "a6f9103e-dcc2-4f7a-a8ca-eaa831f5f83b",
    "Jeff Miracola",
    crate::card::CardRules::unsupported(),
);
...
pub(in crate::card::sets) static FORBID: CardRecord = CardRecord::new(
    "Forbid",
    "29df5ef7-d679-4543-bdb7-3984155c87e0",
    "Scott Kirschner",
    CardRules::new_instant(mana_cost!("{1}{U}{U}")).with_abilities(&[
        ...
        .override_text(
            "Buyback—Discard two cards. (You may discard two cards in \
             addition to any other costs as you cast this spell. If you \
             do, put this card into your hand as it resolves.)",
        ),
...
pub(in crate::card::sets) static KEEPER_OF_THE_MIND: CardRecord = CardRecord::new(
    "Keeper of the Mind",
    "7bc232d4-ab4f-4d88-a9ec-72403d05ec04",
    "Matthew D. Wilson",
    crate::card::CardRules::unsupported(),
);
...
pub(in crate::card::sets) static KILLER_WHALE: CardRecord = CardRecord::new(
    "Killer Whale",
    "d932f6d3-4918-4a41-836c-4eaa6cfac049",
    "Stephen Daniele",
...
pub(in crate::card::sets) static MANA_BREACH: CardRecord = CardRecord::new(
    "Mana Breach",
    "3a97f019-5ad9-4520-ba79-2c9b259748d9",
    "Rebecca Guay",
    CardRules::new_enchantment(mana_cost!("{2}{U}")).with_ability(AbilityDef::triggered(
        "Whenever a player casts a spell, that player returns a land \
...
pub(in crate::card::sets) static MERFOLK_LOOTER: CardRecord = CardRecord::new(
    "Merfolk Looter",
    "0fbb1c41-388f-4ff2-af37-ad64a0f4618e",
    "Ron Spencer",
...
pub(in crate::card::sets) static MIROZEL: CardRecord = CardRecord::new(
    "Mirozel",
    "16417e94-e33f-4ed4-bb3e-52f29f7d441b",
    "Jim Nelson",
    CardRules::new_creature(mana_cost!("{3}{U}"), &["Illusion"], 2, 3).with_abilities(&[
        abilities::flying(),
        AbilityDef::triggered(
            "When this creature becomes the target of a spell or \
             ability, return this creature to its owner's hand.",
...
pub(in crate::card::sets) static OATH_OF_SCHOLARS: CardRecord = CardRecord::new(
    "Oath of Scholars",
    "d61376ad-21c8-4d34-b37d-ed60877f5d4a",
    "Michael Sutfin",
    CardRules::new_enchantment(mana_cost!("{3}{U}")).with_ability(
        AbilityDef::triggered_with_targets(
            "At the beginning of each player's upkeep, that player \
             chooses target player who has more cards in hand than they \
             do and is their opponent. The first player may discard \
...
pub(in crate::card::sets) static ROBE_OF_MIRRORS: CardRecord = CardRecord::new(
    "Robe of Mirrors",
    "371720a2-ec3f-43a5-9551-c018e164e79f",
    "John Matson",
...
pub(in crate::card::sets) static ROOTWATER_MYSTIC: CardRecord = CardRecord::new(
    "Rootwater Mystic",
    "94af81f2-383c-4129-b8dc-60633c3f4ea1",
    "Michael Sutfin",
...
pub(in crate::card::sets) static SCHOOL_OF_PIRANHA: CardRecord = CardRecord::new(
    "School of Piranha",
    "71217af5-3538-4e42-9343-3949b5306671",
    "Daren Bader",
...
pub(in crate::card::sets) static SCRIVENER: CardRecord = CardRecord::new(
    "Scrivener",
    "8b236bba-160a-4637-a83e-8456834ce59f",
    "Heather Hudson",
    CardRules::new_creature(mana_cost!("{4}{U}"), &["Human", "Wizard"], 2, 2).with_ability(
        abilities::enters_trigger_with_targets(
            "When this creature enters, you may return target instant \
             card from your graveyard to your hand.",
            &[AbilityTargetDef::up_to(
                AbilityTargetPredicate::Object {
...
pub(in crate::card::sets) static THALAKOS_DRIFTERS: CardRecord = CardRecord::new(
    "Thalakos Drifters",
    "468e13d2-6bd7-403c-8e2e-e00917b39597",
    "Andrew Robinson",
...
pub(in crate::card::sets) static THALAKOS_SCOUT: CardRecord = CardRecord::new(
    "Thalakos Scout",
    "1703fe9d-ca70-4e8a-9d6a-6173a17d0f04",
    "John Matson",
...
const THEFT_OF_DREAMS_REPRINT: PrintingRecord = PrintingRecord::reprint(
    &crate::card::sets::y1997::portal::THEFT_OF_DREAMS,
...
pub(in crate::card::sets) static TREASURE_TROVE: CardRecord = CardRecord::new(
    "Treasure Trove",
    "f23ce909-e744-47ca-943d-62d97e97b1ea",
    "Michael Sutfin",
...
pub(in crate::card::sets) static WHIPTONGUE_FROG: CardRecord = CardRecord::new(
    "Whiptongue Frog",
    "6fc17186-e786-46a3-9812-4a6e367e78b9",
    "Jeff Miracola",
...
pub(in crate::card::sets) static CARNOPHAGE: CardRecord = CardRecord::new(
    "Carnophage",
    "d17c057f-cb1b-4895-831a-fb35c75d3845",
    "Pete Venters",
...
pub(in crate::card::sets) static CULLING_THE_WEAK: CardRecord = CardRecord::new(
    "Culling the Weak",
    "50c33f18-0a5c-4e46-ab0d-6e450915594f",
    "Scott M. Fischer",
...
pub(in crate::card::sets) static CURSED_FLESH: CardRecord = CardRecord::new(
    "Cursed Flesh",
    "7433b9bf-ee6e-41fe-b826-0d20584198b1",
    "Ron Spencer",
...
pub(in crate::card::sets) static DAUTHI_CUTTHROAT: CardRecord = CardRecord::new(
    "Dauthi Cutthroat",
    "127b8994-fff8-4500-8ab4-244eeb3ed110",
    "Dermot Power",
...
pub(in crate::card::sets) static DAUTHI_JACKAL: CardRecord = CardRecord::new(
    "Dauthi Jackal",
    "419871bc-f036-4244-8b6c-3857ebe993f3",
    "Adam Rex",
...
pub(in crate::card::sets) static DAUTHI_WARLORD: CardRecord = CardRecord::new(
    "Dauthi Warlord",
    "af3ca689-482a-457d-9744-0bd79981f361",
    "Kev Walker",
    CardRules::new_creature(mana_cost!("{1}{B}"), &["Dauthi", "Soldier"], 0, 1).with_abilities(&[
        abilities::shadow(),
        AbilityDef::static_ability(
            "Dauthi Warlord's power is equal to the number of creatures \
             on the battlefield with shadow.",
            EffectDef::StaticApply {
                recipient: EffectRecipientDef::Source,
...
pub(in crate::card::sets) static DEATH_S_DUET: CardRecord = CardRecord::new(
    "Death's Duet",
    "4756b6fd-2bb2-4be1-9b02-851a26ff4303",
    "Keith Parkinson",
...
pub(in crate::card::sets) static ENTROPIC_SPECTER: CardRecord = CardRecord::new(
    "Entropic Specter",
    "bdb04d81-b0ab-4bc7-935d-c31005887240",
    "Ron Spencer",
    CardRules::new_creature(mana_cost!("{3}{B}{B}"), &["Specter", "Spirit"], 0, 0).with_abilities(
        &[
            ...
            AbilityDef::static_ability(
                "Entropic Specter's power and toughness are each equal to \
...
pub(in crate::card::sets) static FUGUE: CardRecord = CardRecord::new(
    "Fugue",
    "1629cd63-95aa-40b6-aa57-7fb88f569e59",
    "Randy Gallegos",
...
pub(in crate::card::sets) static HATRED: CardRecord = CardRecord::new(
    "Hatred",
    "2383a8d9-96fd-4f9a-bcf9-eb81fdb15ead",
    "Brom",
    CardRules::new_instant(mana_cost!("{3}{B}{B}")).with_ability(
        AbilityDef::spell_with_additional_cost(
            "As an additional cost to cast this spell, pay X \
...
pub(in crate::card::sets) static KEEPER_OF_THE_DEAD: CardRecord = CardRecord::new(
    "Keeper of the Dead",
    "6b641171-35bc-4945-ada9-3ea28ea9fabf",
    "Brom",
    crate::card::CardRules::unsupported(),
);
...
pub(in crate::card::sets) static MIND_MAGGOTS: CardRecord = CardRecord::new(
    "Mind Maggots",
    "c3c92a7f-a250-4497-aa7a-0394e94ef13d",
    "Ron Spencer",
    CardRules::new_creature(mana_cost!("{3}{B}"), &["Insect"], 2, 2).with_ability(
        abilities::enters_trigger(
            "When this creature enters, discard any number of creature \
             cards. For each card discarded this way, put two +1/+1 \
            ...
            EffectDef::Choose(ChooseDef {
                ...
                then: &EffectDef::Sequence(&[
                    EffectDef::discard_cards(EffectRecipientDef::objects(ObjectSetDef::Binding(
                        ParentBinding,
                    ))),
...
pub(in crate::card::sets) static NAUSEA: CardRecord = CardRecord::new(
    "Nausea",
    "a10531d8-fc99-4a2b-94b0-97a25521d725",
    "Jeff Miracola",
...
pub(in crate::card::sets) static NECROLOGIA: CardRecord = CardRecord::new(
    "Necrologia",
    "8c2ee9d9-20be-46f0-8752-1df50942f59c",
    "Brom",
    crate::card::CardRules::unsupported(),
);
...
pub(in crate::card::sets) static OATH_OF_GHOULS: CardRecord = CardRecord::new(
    "Oath of Ghouls",
    "1102f35a-ae62-479d-b61c-31a82978aedd",
    "Brom",
    crate::card::CardRules::unsupported(),
);
...
pub(in crate::card::sets) static PIT_SPAWN: CardRecord = CardRecord::new(
    "Pit Spawn",
    "669ad60b-4053-4f07-9072-52e6ff65b4e3",
    "Thomas M. Baxa",
...
pub(in crate::card::sets) static PLAGUEBEARER: CardRecord = CardRecord::new(
    "Plaguebearer",
    "a8493df6-9954-4e33-867c-ca4bcf3953b2",
    "Ron Spencer",
...
pub(in crate::card::sets) static RECURRING_NIGHTMARE: CardRecord = CardRecord::new(
    "Recurring Nightmare",
    "c8173030-1c33-417c-b8e9-79231b6a85a7",
    "Jeff Laubenstein",
...
pub(in crate::card::sets) static SCARE_TACTICS: CardRecord = CardRecord::new(
    "Scare Tactics",
    "6a9d4e11-ce2e-445a-9536-756a6687d6d7",
    "DiTerlizzi",
...
pub(in crate::card::sets) static SLAUGHTER: CardRecord = CardRecord::new(
    "Slaughter",
    "8ff06c7d-5e78-4bcf-864b-34487f6555b2",
    "Pete Venters",
    CardRules::new_instant(mana_cost!("{2}{B}{B}")).with_abilities(&[
        abilities::buyback(&[CostDef::pay_life(CostQuantityDef::Fixed(4))]).override_text(
            "Buyback—Pay 4 life. (You may pay 4 life in addition to any \
             other costs as you cast this spell. If you do, put this \
...
pub(in crate::card::sets) static SPIKE_CANNIBAL: CardRecord = CardRecord::new(
    "Spike Cannibal",
    "64003772-c62f-4728-a00c-48c78991c6ae",
    "Joel Biske",
    crate::card::CardRules::unsupported(),
);
...
pub(in crate::card::sets) static THRULL_SURGEON: CardRecord = CardRecord::new(
    "Thrull Surgeon",
    "d6e89bf1-42c9-4829-a565-78cac632810b",
    "rk post",
    CardRules::new_creature(mana_cost!("{1}{B}"), &["Thrull"], 1, 1).with_ability(
        AbilityDef::activated_with_targets(
            "{1}{B}, Sacrifice this creature: Look at target player's \
             hand and choose a card from it. That player discards that \
            ...
            EffectDef::Sequence(&[
                ...
                EffectDef::Choose(ChooseDef {
                    ...
                    maximum: 1,
                    visibility: ChoiceVisibilityDef::Private,
                    then: &EffectDef::discard_cards(EffectRecipientDef::object(
...
pub(in crate::card::sets) static VAMPIRE_HOUNDS: CardRecord = CardRecord::new(
    "Vampire Hounds",
    "746bc301-9f08-4d9b-819e-690f6fce6bc8",
    "Kev Walker",
...
pub(in crate::card::sets) static VOLRATH_S_DUNGEON: CardRecord = CardRecord::new(
    "Volrath's Dungeon",
    "a4ab28e1-74e1-4c4e-920f-a658c6a44d75",
    "Stephen Daniele",
    CardRules::new_enchantment(mana_cost!("{2}{B}{B}")).with_abilities(&[
        AbilityDef::activated(
            "Pay 5 life: Destroy this enchantment. Any player may \
        ...
        AbilityDef::activated_with_targets(
            "Discard a card: Target player puts a card from their hand \
             on top of their library. Activate only as a sorcery.",
            &[CostDef::discard(ObjectPredicateDef::Any)],
            &[AbilityTargetDef::exactly_one(
                AbilityTargetPredicate::Player(PlayerRelation::Any),
            )],
...
pub(in crate::card::sets) static ANARCHIST: CardRecord = CardRecord::new(
    "Anarchist",
    "a298df66-2075-40a7-bced-457656b6b788",
    "Brom",
    CardRules::new_creature(mana_cost!("{4}{R}"), &["Human", "Wizard"], 2, 2).with_ability(
        abilities::enters_trigger_with_targets(
            "When this creature enters, you may return target sorcery \
             card from your graveyard to your hand.",
            &[AbilityTargetDef::up_to(
                AbilityTargetPredicate::Object {
...
pub(in crate::card::sets) static CINDER_CRAWLER: CardRecord = CardRecord::new(
    "Cinder Crawler",
    "a9406050-d76b-4569-a463-e21acaf84166",
    "Jim Nelson",
...
pub(in crate::card::sets) static DIZZYING_GAZE: CardRecord = CardRecord::new(
    "Dizzying Gaze",
    "71a482cf-a1cd-47b5-a76a-08e03965c679",
    "Thomas M. Baxa",
...
pub(in crate::card::sets) static FIGHTING_CHANCE: CardRecord = CardRecord::new(
    "Fighting Chance",
    "ca75f6e9-5eee-4904-88c0-71ec730a0f23",
    "Mike Raabe",
                    ...
                    on_success: &EffectDef::PreventDamage {
                        prevention: crate::card::DamagePreventionDef::unlimited(
                            crate::card::DamageEventMatcherDef {
                                ...
                                ..crate::card::DamageEventMatcherDef::from(ObjectRefDef::Binding(
                                    ParentBinding,
                                ))
                            },
                        ),
...
pub(in crate::card::sets) static FLOWSTONE_FLOOD: CardRecord = CardRecord::new(
    "Flowstone Flood",
    "8bcda003-6fac-4879-87e6-ec0c115630ba",
    "Paolo Parente",
    crate::card::CardRules::unsupported(),
);
...
pub(in crate::card::sets) static FURNACE_BROOD: CardRecord = CardRecord::new(
    "Furnace Brood",
    "0a79c6d9-96f1-434a-89b8-d773aa77ac5e",
    "Jeff Miracola",
...
pub(in crate::card::sets) static KEEPER_OF_THE_FLAME: CardRecord = CardRecord::new(
    "Keeper of the Flame",
    "9bf246ca-9dfc-400f-8883-acc80ac016e1",
    "Terese Nielsen",
    crate::card::CardRules::unsupported(),
);
...
pub(in crate::card::sets) static MAGE_IL_VEC: CardRecord = CardRecord::new(
    "Mage il-Vec",
    "04e3e38b-2191-4b92-ae5d-bb9397d24a27",
    "John Matson",
...
pub(in crate::card::sets) static MANIACAL_RAGE: CardRecord = CardRecord::new(
    "Maniacal Rage",
    "f3aa840f-6a70-4674-acb7-ded0ea4397d8",
    "Pete Venters",
...
pub(in crate::card::sets) static MOGG_ASSASSIN: CardRecord = CardRecord::new(
    "Mogg Assassin",
    "1124725d-e643-43a1-873e-255636c7f334",
    "Dermot Power",
    CardRules::new_creature(mana_cost!("{2}{R}"), &["Goblin", "Assassin"], 2, 1).with_ability(
        AbilityDef::activated_with_targets(
            "{T}: You choose target creature an opponent controls, and \
             that opponent chooses target creature. Flip a coin. If you \
             win the flip, destroy the creature you chose. If you lose \
             the flip, destroy the creature your opponent chose.",
            &[CostDef::TapSource],
            &[
                AbilityTargetDef::exactly_one(AbilityTargetPredicate::Object {
                    object: ObjectPredicateDef::HasType(CardType::Creature),
            ...
            EffectDef::Randomized {
                likelihood: LikelihoodDef::new(0.5),
                on_success: &EffectDef::destroy_target(TargetIndex::PRIMARY),
                on_failure: &EffectDef::destroy_target(TargetIndex(1)),
            },
        ),
    ),
);
...
pub(in crate::card::sets) static MONSTROUS_HOUND: CardRecord = CardRecord::new(
    "Monstrous Hound",
    "d5066b1b-3910-4434-83d6-030851f20bcf",
    "Dermot Power",
    crate::card::CardRules::unsupported(),
);
...
pub(in crate::card::sets) static OGRE_SHAMAN: CardRecord = CardRecord::new(
    "Ogre Shaman",
    "cb3224ac-9b60-48cf-9734-86768fd370ac",
    "Paolo Parente",
...
pub(in crate::card::sets) static ONSLAUGHT: CardRecord = CardRecord::new(
    "Onslaught",
    "0afaf142-dbca-45bf-aea2-01c53bda635a",
    "Paolo Parente",
...
pub(in crate::card::sets) static PANDEMONIUM: CardRecord = CardRecord::new(
    "Pandemonium",
    "5f618231-28bb-4cdd-b887-a8aa186814d5",
    "Pete Venters",
    CardRules::new_enchantment(mana_cost!("{3}{R}")).with_ability(
        AbilityDef::triggered_with_targets(
            "Whenever a creature enters, that creature's controller may \
             have it deal damage equal to its power to any target of \
             their choice.",
            TriggerEventDef::zone_changed(
                ObjectPredicateDef::HasType(CardType::Creature),
                None,
            ...
            &[
                AbilityTargetDef::up_to(AbilityTargetPredicate::AnyTarget, 1)
                    .chosen_by_event_player(),
            ],
            EffectDef::damage_from(
...
pub(in crate::card::sets) static PAROXYSM: CardRecord = CardRecord::new(
    "Paroxysm",
    "53320321-4f02-40ee-8171-2375b1d4ed66",
    "Scott Kirschner",
    CardRules::new_enchantment(mana_cost!("{1}{R}"))
        .with_subtypes(&["Aura"])
        .with_abilities(&[
            ...
            abilities::enchanted_controller_upkeep(
                "At the beginning of the upkeep of enchanted creature's \
                 controller, that player reveals the top card of their \
                 library. If that card is a land card, destroy that \
                 creature. Otherwise, it gets +3/+3 until end of turn.",
...
pub(in crate::card::sets) static PRICE_OF_PROGRESS: CardRecord = CardRecord::new(
    ...
    CardRules::new_instant(mana_cost!("{1}{R}")).with_ability(AbilityDef::spell(
        "Price of Progress deals damage to each player equal to \
...
const RAGING_GOBLIN_REPRINT: PrintingRecord = PrintingRecord::reprint(
    ...
    "1f0a166c-f7c0-45b4-aa90-053ce545cfb2",
    "Brian Snõddy",
);
...
pub(in crate::card::sets) static RECKLESS_OGRE: CardRecord = CardRecord::new(
    "Reckless Ogre",
    "90d27b79-a22d-48d9-86b2-7ad02cab8697",
    "Paolo Parente",
...
pub(in crate::card::sets) static SABERTOOTH_WYVERN: CardRecord = CardRecord::new(
    "Sabertooth Wyvern",
    "84c1d384-d341-4bab-bf71-5dbcf76d51e8",
    "Keith Parkinson",
...
pub(in crate::card::sets) static SCALDING_SALAMANDER: CardRecord = CardRecord::new(
    "Scalding Salamander",
    "5a0e9433-88d7-4bfc-99a0-ff47807fd594",
    "Terese Nielsen",
    CardRules::new_creature(mana_cost!("{2}{R}"), &["Salamander"], 2, 1).with_ability(
        AbilityDef::triggered(
            "Whenever this creature attacks, you may have it deal 1 \
             damage to each creature without flying defending player \
             controls.",
...
pub(in crate::card::sets) static SEISMIC_ASSAULT: CardRecord = CardRecord::new(
    "Seismic Assault",
    "cc494af5-4da4-43f5-a193-426ef84d80a7",
    "Dermot Power",
...
pub(in crate::card::sets) static SHATTERING_PULSE: CardRecord = CardRecord::new(
    "Shattering Pulse",
    "89d3b846-6071-4d65-86ba-da08c4bd0aa1",
    "Donato Giancola",
...
// allows CostDef::DiscardCardsAtRandom on an activated ability but not on a cast; the spell-side
// allowlist offers only Discard, which lets the caster choose.
...
pub(in crate::card::sets) static SPELLSHOCK: CardRecord = CardRecord::new(
    "Spellshock",
    "52db2a78-e1c5-4732-a4ee-04b4c540edbe",
    "Thomas M. Baxa",
    ...
    CardRules::new_creature(mana_cost!("{2}{G}"), &["Human", "Druid"], 1, 3).with_ability(
        AbilityDef::triggered(
            "Whenever this creature deals damage to an opponent, you may \
             ...
             a land card. If you do, put that card onto the battlefield \
             and put all other cards revealed this way into your \
             graveyard.",
...
pub(in crate::card::sets) static CARTOGRAPHER: CardRecord = CardRecord::new(
    "Cartographer",
    "7f2c2cc9-37ce-435e-9df2-083d5e3c8c5c",
    "Jeff Laubenstein",
    CardRules::new_creature(mana_cost!("{2}{G}"), &["Human"], 2, 2).with_ability(
        abilities::enters_trigger_with_targets(
            "When this creature enters, you may return target land card \
...
pub(in crate::card::sets) static CRASHING_BOARS: CardRecord = CardRecord::new(
    "Crashing Boars",
    "a2965bd5-4f16-443a-9133-adb92cf0e12b",
    "Ron Spencer",
    crate::card::CardRules::unsupported(),
);
...
pub(in crate::card::sets) static ELVISH_BERSERKER: CardRecord = CardRecord::new(
    "Elvish Berserker",
    "dfa69a8e-1b75-4d93-918d-d772cec69e99",
    "Paolo Parente",
...
pub(in crate::card::sets) static JACKALOPE_HERD: CardRecord = CardRecord::new(
    "Jackalope Herd",
    "cb80105c-d2c0-4f8c-9302-5e6152a60f54",
    "Ron Spencer",
...
pub(in crate::card::sets) static KEEPER_OF_THE_BEASTS: CardRecord = CardRecord::new(
    ...
    "cccccf78-8b00-406b-a2b7-0e6ba76703d0",
    "rk post",
    CardRules::new_creature(mana_cost!("{G}{G}"), &["Human", "Wizard"], 1, 2).with_ability(
        AbilityDef::activated_with_targets(
            "{G}, {T}: Choose target opponent who controls more \
             creatures than you do as you activate this ability. Create \
...
pub(in crate::card::sets) static MANABOND: CardRecord = CardRecord::new(
    "Manabond",
    "212ca7e7-5ba3-4da7-a2f0-16c721004bac",
    "Stephen Daniele",
    CardRules::new_enchantment(mana_cost!("{G}")).with_ability(AbilityDef::triggered(
        "At the beginning of your end step, you may reveal your hand \
         and put all land cards from it onto the battlefield. If you \
         do, discard your hand.",
        TriggerEventDef::StepBegins {
...
pub(in crate::card::sets) static MIRRI_CAT_WARRIOR: CardRecord = CardRecord::new(
    "Mirri, Cat Warrior",
    "6d1682dd-5a99-4bee-a2c2-c8735047e1a9",
    "Daren Bader",
...
pub(in crate::card::sets) static OATH_OF_DRUIDS: CardRecord = CardRecord::new(
    "Oath of Druids",
    "cf14de50-d123-400c-862e-2c95fd2aa23f",
    "Daren Bader",
...
pub(in crate::card::sets) static PLATED_ROOTWALLA: CardRecord = CardRecord::new(
    "Plated Rootwalla",
    "4bf4da70-c656-4e40-bb0f-68e9dda024c9",
    "Randy Elliott",
...
pub(in crate::card::sets) static PREDATORY_HUNGER: CardRecord = CardRecord::new(
    "Predatory Hunger",
    "db6d9d28-3a05-4dfa-a322-36b4cc2697d4",
    "Brom",
    CardRules::new_enchantment(mana_cost!("{G}"))
        .with_subtypes(&["Aura"])
        .with_abilities(&[
            abilities::enchant_creature(),
            AbilityDef::triggered(
                "Whenever an opponent casts a creature spell, put a +1/+1 \
...
pub(in crate::card::sets) static PYGMY_TROLL: CardRecord = CardRecord::new(
    "Pygmy Troll",
    "7be9714d-125f-4700-879d-b920fe9f1b68",
    "Daniel Gelon",
...
pub(in crate::card::sets) static RABID_WOLVERINES: CardRecord = CardRecord::new(
    "Rabid Wolverines",
    "99121a2b-c735-47be-b01e-cdf59809e7f3",
    "Daren Bader",
...
pub(in crate::card::sets) static RECLAIM: CardRecord = CardRecord::new(
    "Reclaim",
    "2b47c082-57f6-4f69-87e8-a07cad9ef042",
    "Andrew Robinson",
...
pub(in crate::card::sets) static RESUSCITATE: CardRecord = CardRecord::new(
    "Resuscitate",
    "f5707560-fcc6-4aca-adce-d41de45f37e8",
    "Rebecca Guay",
...
pub(in crate::card::sets) static SKYSHROUD_ELITE: CardRecord = CardRecord::new(
    "Skyshroud Elite",
    "f6a496a4-1b4c-4c5d-99e5-ec40601c759d",
    "Paolo Parente",
...
pub(in crate::card::sets) static SKYSHROUD_WAR_BEAST: CardRecord = CardRecord::new(
    "Skyshroud War Beast",
    "19d809c1-e674-40b8-816d-c45d77c66722",
    "Jim Nelson",
    CardRules::new_creature(mana_cost!("{1}{G}"), &["Beast"], 0, 0).with_abilities(&[
        ...
        AbilityDef::static_ability(
            "Skyshroud War Beast's power and toughness are each equal to \
             the number of nonbasic lands the chosen player controls.",
            EffectDef::StaticApply {
                recipient: EffectRecipientDef::Source,
                effect: AppliedEffectDef::define_power_toughness(
...
pub(in crate::card::sets) static SONG_OF_SERENITY: CardRecord = CardRecord::new(
    "Song of Serenity",
    "2ba85b2f-37da-4595-9880-8e9f1ddbac09",
    "DiTerlizzi",
...
pub(in crate::card::sets) static SPIKE_HATCHER: CardRecord = CardRecord::new(
    "Spike Hatcher",
    "1f79fb79-37a0-483f-ba19-853cbfffc73d",
    "Stephen Daniele",
...
pub(in crate::card::sets) static SPIKE_ROGUE: CardRecord = CardRecord::new(
    "Spike Rogue",
    "f0d9b671-344b-460d-8f65-d65129db91c3",
    "Heather Hudson",
    crate::card::CardRules::unsupported(),
);
...
pub(in crate::card::sets) static SPIKE_WEAVER: CardRecord = CardRecord::new(
    "Spike Weaver",
    "9c561a2a-91c6-4d4b-9f96-bffd43a00478",
    "Mike Raabe",
    CardRules::new_creature(mana_cost!("{2}{G}{G}"), &["Spike"], 0, 0).with_abilities(&[
        ...
        AbilityDef::activated(
            "{1}, Remove a +1/+1 counter from this creature: Prevent all \
...
pub(in crate::card::sets) static SURVIVAL_OF_THE_FITTEST: CardRecord = CardRecord::new(
    ...
    "c060c178-3c0e-493f-b6f0-ead5b1d6f191",
    "Pete Venters",
    CardRules::new_enchantment(mana_cost!("{1}{G}")).with_ability(AbilityDef::activated(
        "{G}, Discard a creature card: Search your library for a \
         creature card, reveal that card, put it into your hand, \
         then shuffle.",
        &[
            CostDef::Mana(mana_cost!("{G}")),
            CostDef::discard(ObjectPredicateDef::HasType(CardType::Creature)),
...
const WOOD_ELVES_REPRINT: PrintingRecord = PrintingRecord::reprint(
    ...
    "4716bb55-0821-4809-9bc0-04e299b09549",
    "Rebecca Guay",
);
...
pub(in crate::card::sets) static COAT_OF_ARMS: CardRecord = CardRecord::new(
    "Coat of Arms",
    "9e32c939-1d64-4082-bafe-59dfa9c054f6",
    "Scott M. Fischer",
    crate::card::CardRules::unsupported(),
);
...
pub(in crate::card::sets) static ERRATIC_PORTAL: CardRecord = CardRecord::new(
    "Erratic Portal",
    "2e652007-02f0-424f-b52c-c1540d1939bd",
    "John Matson",
...
pub(in crate::card::sets) static MEDICINE_BAG: CardRecord = CardRecord::new(
    "Medicine Bag",
    "399c06d5-af2a-47a1-9239-ff14224a026b",
    "DiTerlizzi",
...
pub(in crate::card::sets) static MEMORY_CRYSTAL: CardRecord = CardRecord::new(
    "Memory Crystal",
    "c786ea5b-52ad-4d1b-855e-ce6d0b9af67e",
    "Michael Sutfin",
    crate::card::CardRules::unsupported(),
);
...
pub(in crate::card::sets) static MINDLESS_AUTOMATON: CardRecord = CardRecord::new(
    "Mindless Automaton",
    "6ddfc5ab-b11b-4ad7-ab46-8ee60d938a5b",
    "Brian Snõddy",
...
pub(in crate::card::sets) static NULL_BROOCH: CardRecord = CardRecord::new(
    "Null Brooch",
    "d5d5a0c6-916c-428a-ae66-8adc8844e56e",
    "DiTerlizzi",
    CardRules::new_artifact(mana_cost!("{4}")).with_ability(AbilityDef::activated_with_targets(
...
pub(in crate::card::sets) static SKYSHAPER: CardRecord = CardRecord::new(
    "Skyshaper",
    "234ed934-6ea7-41f6-bd13-3df8662a3a1d",
    "Donato Giancola",
...
pub(in crate::card::sets) static SPELLBOOK: CardRecord = CardRecord::new(
    "Spellbook",
    "33fb104c-f8ca-4da2-8f1f-8fe6f291407e",
    "Ciruelo",
...
pub(in crate::card::sets) static SPHERE_OF_RESISTANCE: CardRecord = CardRecord::new(
    ...
    "17f4d2a5-bb85-4662-b2dd-a363ec7eab9b",
    "Doug Chaffee",
...
pub(in crate::card::sets) static THOPTER_SQUADRON: CardRecord = CardRecord::new(
    "Thopter Squadron",
    "d3ac2d30-7c9a-40b3-812e-e77e49229f48",
    "Doug Chaffee",
    CardRules::new_artifact_creature(mana_cost!("{5}"), &["Thopter"], 0, 0).with_abilities(&[
        ...
        .with_activation_timing(ActivationTimingDef::SorcerySpeed),
        AbilityDef::activated(
            "{1}, Sacrifice another Thopter: Put a +1/+1 counter on this \
...
pub(in crate::card::sets) static TRANSMOGRIFYING_LICID: CardRecord = CardRecord::new(
    ...
    "1a115563-81da-42f6-95c4-22ae7bb51a0f",
    "Jim Nelson",
    crate::card::CardRules::unsupported(),
);
...
pub(in crate::card::sets) static WORKHORSE: CardRecord = CardRecord::new(
    "Workhorse",
    "c2571ff7-0287-4ba2-8365-5ff08de641a2",
    "DiTerlizzi",
