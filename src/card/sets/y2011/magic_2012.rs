...
const ANGELS_MERCY_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2009::magic_2010::ANGELS_MERCY)
        .with_art("4e2b0942-423a-4378-b8cd-022a6b608a2e", "Andrew Robinson");
...
const ARCHON_OF_JUSTICE_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2008::eventide::ARCHON_OF_JUSTICE)
        .with_art("dcaee06f-edc1-4c3a-9ecc-97882c1b911e", "Jason Chan");
...
const ASSAULT_GRIFFIN_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2010::magic_2011::ASSAULT_GRIFFIN)
        .with_art("1a791d03-bcbd-437a-8222-3de97d26f0d0", "Jesper Ejsing");
...
const AURAMANCER_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2001::odyssey::AURAMANCER)
        .with_art("b702dc6d-4c05-4313-b303-c321847ad6a9", "Rebecca Guay");
...
const CELESTIAL_PURGE_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2009::conflux::CELESTIAL_PURGE)
        .with_art("75f75e85-9454-4008-aa51-a1d5965752d6", "David Palumbo");

// M12 12 — Day of Judgment (reprint)
const DAY_OF_JUDGMENT_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2009::zendikar::DAY_OF_JUDGMENT)
        .with_art("1ed43ed8-9490-4433-843f-9020cd3470a1", "Vincent Proce");

// M12 13 — Demystify (reprint)
const DEMYSTIFY_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2002::onslaught::DEMYSTIFY)
        .with_art("8f1b042f-f059-4e9f-a459-8682688f45cf", "Véronique Meignaud");
...
const ELITE_VANGUARD_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2009::magic_2010::ELITE_VANGUARD)
        .with_art("f03487e9-f584-4bbd-8335-4dd001a88b52", "Mark Tedin");

// M12 16 — Gideon Jura (reprint)
const GIDEON_JURA_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2010::rise_of_the_eldrazi::GIDEON_JURA)
        .with_art("1c58b63c-e3e5-4575-849c-9a6a00821286", "Aleksi Briclot");
...
const GRIFFIN_SENTINEL_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2009::magic_2010::GRIFFIN_SENTINEL)
        .with_art("3c8f2fea-2bc1-49fc-91c9-83698f43262f", "Warren Mahy");
...
const HONOR_OF_THE_PURE_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2009::magic_2010::HONOR_OF_THE_PURE)
        .with_art("650a6831-c352-4ca7-9f8f-43ea99a1cf33", "Greg Staples");

// M12 24 — Lifelink (reprint)
const LIFELINK_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2009::magic_2010::LIFELINK)
        .with_art("a8e207d4-9930-4aff-a7c8-b53bd1b5d566", "Terese Nielsen");

// M12 25 — Mesa Enchantress (reprint)
const MESA_ENCHANTRESS_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2007::planar_chaos::MESA_ENCHANTRESS)
        .with_art("691dcce5-ac3d-4970-b3ff-3db485f9f5c3", "Randy Gallegos");

// M12 26 — Mighty Leap (reprint)
const MIGHTY_LEAP_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2010::magic_2011::MIGHTY_LEAP)
        .with_art("446e1676-ae7d-46ee-af91-bb54e4d18a78", "rk post");

// M12 27 — Oblivion Ring (reprint)
const OBLIVION_RING_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2007::lorwyn::OBLIVION_RING)
        .with_art("9efc5a2a-eb76-410d-98e6-1455108faa52", "Franz Vohwinkel");

// M12 28 — Pacifism (reprint)
const PACIFISM_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y1996::mirage::PACIFISM)
        .with_art("783ccfbb-4063-4614-8135-11787227ce97", "Robert Bliss");
...
const ROC_EGG_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2010::magic_2011::ROC_EGG)
        .with_art("92ae6206-ff0d-4248-b9cb-4ffbf20504fa", "Paul Bonner");

// M12 33 — Serra Angel (reprint)
const SERRA_ANGEL_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y1993::alpha::SERRA_ANGEL)
        .with_art("3c31fb9d-ec0d-4555-814d-62642d52c710", "Greg Staples");
...
const SIEGE_MASTODON_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2009::magic_2010::SIEGE_MASTODON)
        .with_art("39c340a3-0118-48d3-99ab-f4a0e7099325", "Matt Cavotta");
...
const STORMFRONT_PEGASUS_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2009::magic_2010::STORMFRONT_PEGASUS)
        .with_art("bf0ba2d2-09d5-4755-a18f-40cf19d88f25", "rk post");

// M12 39 — Sun Titan (reprint)
const SUN_TITAN_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2010::magic_2011::SUN_TITAN)
        .with_art("ea3e77ed-9015-4407-b78c-494e46b67b07", "Todd Lockwood");
...
const AETHER_ADEPT_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2010::magic_2011::AETHER_ADEPT)
        .with_art("fa6f04ca-cab7-4c86-a56c-79d6ae3b73e6", "Eric Deschamps");

// M12 42 — Alluring Siren (reprint)
const ALLURING_SIREN_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2009::magic_2010::ALLURING_SIREN)
        .with_art("a6434841-6cca-4397-b1fa-5ce34dc0b7f3", "Chippy");
...
const BELLTOWER_SPHINX_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2005::ravnica_city_of_guilds::BELLTOWER_SPHINX)
        .with_art("d6829959-dae1-4ddf-8a75-33a77e6b4612", "Jim Nelson");

// M12 47 — Cancel (reprint)
const CANCEL_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2006::time_spiral::CANCEL)
        .with_art("c464b856-e3c0-4b06-a2b0-6663a9aafd26", "David Palumbo");
...
const CORAL_MERFOLK_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y1998::urzas_saga::CORAL_MERFOLK)
        .with_art("c9e8f212-d1c6-4140-a392-73d0e141e708", "rk post");
...
const DIVINATION_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2009::magic_2010::DIVINATION)
        .with_art("1252243c-34e3-447b-b323-fffcbe128278", "Howard Lyon");

// M12 51 — Djinn of Wishes (reprint)
const DJINN_OF_WISHES_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2009::magic_2010::DJINN_OF_WISHES)
        .with_art("74c621dd-9c60-4951-beaf-eb6b597c2f0f", "Kev Walker");

// M12 52 — Flashfreeze (reprint)
const FLASHFREEZE_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2006::coldsnap::FLASHFREEZE)
        .with_art("c425a629-371f-4624-b7a1-b34818ecccad", "Brian Despain");

// M12 53 — Flight (reprint)
const FLIGHT_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y1993::alpha::FLIGHT)
        .with_art("15316953-dcb2-4428-b90a-c90d3d4c45f3", "Mark Zug");
...
const FROST_TITAN_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2010::magic_2011::FROST_TITAN)
        .with_art("358baa9f-390f-4b99-a274-d28f3bd56824", "Mike Bierek");

// M12 56 — Harbor Serpent (reprint)
const HARBOR_SERPENT_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2010::magic_2011::HARBOR_SERPENT)
        .with_art("453d4f1d-b378-49c3-b697-6566b3c455cd", "Daarken");

// M12 57 — Ice Cage (reprint)
const ICE_CAGE_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2009::magic_2010::ICE_CAGE)
        .with_art("a5e14b62-c050-4d43-aeee-873f46d1e295", "Mike Bierek");
...
const JACE_S_ERASURE_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2010::magic_2011::JACE_S_ERASURE)
        .with_art("970f4f34-f834-41a7-aff1-7cef82cefc74", "Jason Chan");
...
const LEVITATION_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y1999::urzas_legacy::LEVITATION)
        .with_art("63e5124a-67c0-44ed-8085-28bf37816423", "Jim Murray");
...
const MANA_LEAK_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y1998::stronghold::MANA_LEAK)
        .with_art("6b123efa-8631-4a07-970d-ff4f980a0522", "Howard Lyon");
...
const MERFOLK_LOOTER_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y1998::exodus::MERFOLK_LOOTER)
        .with_art("aad3aaec-7c88-4925-8023-0cf61bf906c2", "Austin Hsu");
...
const MIND_CONTROL_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2009::magic_2010::MIND_CONTROL)
        .with_art("ec7f77af-17d7-4746-bc83-f455b9b6f9ea", "Ryan Pancoast");
...
const NEGATE_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2008::morningtide::NEGATE)
        .with_art("7f21cd05-2fdb-4c37-90a4-220a3eda23ef", "Jeremy Jarvis");
...
const PONDER_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2007::lorwyn::PONDER)
        .with_art("81c908ee-e70a-4406-a32d-ab5ab17e67b1", "Dan Murayama Scott");

// M12 74 — Redirect (reprint)
const REDIRECT_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2010::magic_2011::REDIRECT)
        .with_art("efdb01f8-209d-4f8b-a280-b45e1ab0b880", "Izzy");
...
const TIME_REVERSAL_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2010::magic_2011::TIME_REVERSAL)
        .with_art("2d6500a1-5aea-4b83-b4dc-560fe547590d", "Howard Lyon");
...
const UNSUMMON_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y1993::alpha::UNSUMMON)
        .with_art("88439b79-f6f4-4d01-8404-a1e02f2aeb55", "Izzy");
...
const BLOOD_SEEKER_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2009::zendikar::BLOOD_SEEKER)
        .with_art("8033de8d-a396-4097-aedd-f9facb800b33", "Greg Staples");
...
const BRINK_OF_DISASTER_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2010::worldwake::BRINK_OF_DISASTER).with_art(
        "dbab78cd-a899-4c5d-86b3-0666adadba87",
        "Alex Horley-Orlandelli",
    );

// M12 85 — Call to the Grave (reprint)
const CALL_TO_THE_GRAVE_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2003::scourge::CALL_TO_THE_GRAVE)
        .with_art("5e1324b6-dba0-4aff-a403-a45d2b405f5b", "Daarken");

// M12 86 — Cemetery Reaper (reprint)
const CEMETERY_REAPER_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2009::magic_2010::CEMETERY_REAPER)
        .with_art("56494d1e-0d7e-4c29-942c-b376ff07cdf8", "Dave Allsop");
...
const CHILD_OF_NIGHT_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2009::magic_2010::CHILD_OF_NIGHT)
        .with_art("c4780079-7f4c-4a43-883f-4722423c4fec", "Ash Wood");

// M12 88 — Consume Spirit (reprint)
const CONSUME_SPIRIT_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2003::mirrodin::CONSUME_SPIRIT)
        .with_art("ef144439-fc8e-4844-8ebb-3e36e05ac9a0", "Justin Sweet");
...
const DEATHMARK_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2006::coldsnap::DEATHMARK)
        .with_art("b101ff4a-8617-4c0a-8503-ed8c857ad000", "Steven Belledin");
...
const DIABOLIC_TUTOR_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2001::odyssey::DIABOLIC_TUTOR)
        .with_art("2db75949-f8cd-4461-83c0-7eaee2196132", "Greg Staples");

// M12 93 — Disentomb (reprint)
const DISENTOMB_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2009::magic_2010::DISENTOMB).with_art(
        "ca10a691-a209-44a3-9925-8638a3c4e1d1",
        "Alex Horley-Orlandelli",
    );

// M12 94 — Distress (reprint)
const DISTRESS_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2004::champions_of_kamigawa::DISTRESS)
        .with_art("630d4080-8183-41fb-8091-740719083765", "Michael C. Hayes");
...
const DOOM_BLADE_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2009::magic_2010::DOOM_BLADE)
        .with_art("077d5ca8-2a94-4d79-9314-c5ca2aa4d14b", "Chippy");
...
const GRAVE_TITAN_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2010::magic_2011::GRAVE_TITAN)
        .with_art("5c70da33-ce5d-4b8b-9c1d-9a356a7e196f", "Nils Hamm");
...
const GRAVEDIGGER_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y1997::portal::GRAVEDIGGER)
        .with_art("11055d4e-3efe-493c-8c18-9e2642267511", "Dermot Power");
...
const MIND_ROT_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y1997::portal::MIND_ROT)
        .with_art("e61ee72e-61ae-4558-8abe-f5eaf5b9fb8a", "Steve Luke");
...
const REASSEMBLING_SKELETON_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2010::archenemy::REASSEMBLING_SKELETON)
        .with_art("75c219bc-a140-4ecd-953a-eef2cc552d58", "Austin Hsu");

// M12 105 — Royal Assassin (reprint)
const ROYAL_ASSASSIN_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y1993::alpha::ROYAL_ASSASSIN)
        .with_art("d12e8109-8215-46b5-a0af-fe7e4b6b10b0", "Mark Zug");
...
const SENGIR_VAMPIRE_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y1993::alpha::SENGIR_VAMPIRE)
        .with_art("e0da3971-0145-4975-8bb1-8c2898d10ae7", "Kev Walker");

// M12 108 — Smallpox (reprint)
const SMALLPOX_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2006::time_spiral::SMALLPOX)
        .with_art("93c8159b-8c1d-480a-b517-dbd67bba1838", "Ryan Pancoast");

// M12 109 — Sorin Markov (reprint)
const SORIN_MARKOV_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2009::zendikar::SORIN_MARKOV)
        .with_art("e25b3a89-3a99-4e02-bf0c-a3cf450da1a1", "Michael Komarck");
...
const SUTURED_GHOUL_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2002::judgment::SUTURED_GHOUL)
        .with_art("8390d9b7-5adf-4039-8682-02bfba421ff9", "Carl Critchlow");
...
const WARPATH_GHOUL_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2009::magic_2010::WARPATH_GHOUL)
        .with_art("94785274-fa79-47cc-9896-0f5f695abb21", "rk post");
...
const ZOMBIE_GOLIATH_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2009::magic_2010::ZOMBIE_GOLIATH)
        .with_art("1985e0bd-05b9-4eaf-9333-6262cf677acd", "E. M. Gist");

// M12 120 — Zombie Infestation (reprint)
const ZOMBIE_INFESTATION_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2001::odyssey::ZOMBIE_INFESTATION)
        .with_art("c84a3e27-841a-4eb5-afcd-ddb87d4280f7", "Thomas M. Baxa");
...
const ACT_OF_TREASON_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2009::magic_2010::ACT_OF_TREASON)
        .with_art("0ea8984c-7176-43e5-931b-c3b6f4747a8b", "Eric Deschamps");
...
const COMBUST_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2010::magic_2011::COMBUST)
        .with_art("f10346e2-46bd-4257-b191-c36c2577c534", "Jaime Jones");
...
const FIERY_HELLHOUND_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2009::magic_2010::FIERY_HELLHOUND)
        .with_art("7c96f7a0-99a3-4ba4-b0f0-9ea36c45d5d5", "Ted Galaday");

// M12 131 — Fireball (reprint)
const FIREBALL_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y1993::alpha::FIREBALL)
        .with_art("f6a86f5d-cfbf-4d8e-9f8e-0f8288907396", "Dave Dorman");

// M12 132 — Firebreathing (reprint)
const FIREBREATHING_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y1993::alpha::FIREBREATHING)
        .with_art("6fbcc269-aaa3-42aa-9898-3f908aaae272", "Aleksi Briclot");

// M12 133 — Flameblast Dragon (reprint)
const FLAMEBLAST_DRAGON_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2008::shards_of_alara::FLAMEBLAST_DRAGON)
        .with_art("c01ab5c8-f9b7-482c-a900-1388b727b89f", "Jaime Jones");

// M12 134 — Fling (reprint)
const FLING_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y1998::stronghold::FLING)
        .with_art("3a439015-0c1c-4322-a6f1-a34040162ac4", "Paolo Parente");
...
const GOBLIN_ARSONIST_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2010::rise_of_the_eldrazi::GOBLIN_ARSONIST)
        .with_art("c24751fd-5e9b-4d7d-83ba-e306b439bbe1", "Wayne Reynolds");
...
const GOBLIN_CHIEFTAIN_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2009::magic_2010::GOBLIN_CHIEFTAIN)
        .with_art("2540ec6b-9ffa-4ab0-bbd3-ddf1efd2db60", "Sam Wood");
...
const GOBLIN_GRENADE_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y1994::fallen_empires::GOBLIN_GRENADE)
        .with_art("394cc2aa-0318-4ccd-a550-99a7eac933c3", "Kev Walker");

// M12 141 — Goblin Piker (reprint)
const GOBLIN_PIKER_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y1998::portal_second_age::GOBLIN_PIKER)
        .with_art("083ec3e7-950c-4e9d-aba5-02ed13d723f0", "DiTerlizzi");

// M12 142 — Goblin Tunneler (reprint)
const GOBLIN_TUNNELER_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2010::rise_of_the_eldrazi::GOBLIN_TUNNELER)
        .with_art("c466bbb3-9758-47e6-8996-3615f4c31924", "Jesper Ejsing");

// M12 143 — Goblin War Paint (reprint)
const GOBLIN_WAR_PAINT_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2009::zendikar::GOBLIN_WAR_PAINT)
        .with_art("fde711c9-fdef-4024-8269-a59ee0748f95", "Austin Hsu");
...
const GRIM_LAVAMANCER_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2002::torment::GRIM_LAVAMANCER)
        .with_art("d9fbe2c9-31d5-4e54-922d-1bc6a865b251", "Michael Sutfin");

// M12 146 — Incinerate (reprint)
const INCINERATE_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y1995::ice_age::INCINERATE).with_art(
        "1af92296-455a-425e-9397-a96d09937767",
        "Zoltan Boros & Gabor Szikszai",
    );

// M12 147 — Inferno Titan (reprint)
const INFERNO_TITAN_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2010::magic_2011::INFERNO_TITAN)
        .with_art("e04c24cb-3c3b-4a35-9694-db512bf394fa", "Kev Walker");
...
const LAVA_AXE_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y1997::portal::LAVA_AXE)
        .with_art("2cf9c3aa-9434-4a62-9bcb-0699a85de9cb", "Brian Snõddy");
...
const LIGHTNING_ELEMENTAL_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y1997::tempest::LIGHTNING_ELEMENTAL)
        .with_art("e106b6af-a13c-42be-9368-9109795de517", "Kev Walker");

// M12 150 — Manabarbs (reprint)
const MANABARBS_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y1993::alpha::MANABARBS)
        .with_art("adf081d5-e644-4f46-8bc8-a754b089acb4", "Jeff Miracola");

// M12 151 — Manic Vandal (reprint)
const MANIC_VANDAL_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2010::magic_2011::MANIC_VANDAL).with_art(
        "985a5866-8c62-46af-a0c0-e69d01d87f4f",
        "Christopher Moeller",
    );

// M12 152 — Reverberate (reprint)
const REVERBERATE_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2010::magic_2011::REVERBERATE)
        .with_art("7062e2f3-bf4a-4a9a-962c-b45718a464bc", "jD");
...
const SHOCK_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y1998::stronghold::SHOCK)
        .with_art("b8fed52c-e84e-41c9-b683-d8b26fa03c5f", "Jon Foster");

// M12 155 — Slaughter Cry (reprint)
const SLAUGHTER_CRY_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2009::zendikar::SLAUGHTER_CRY)
        .with_art("65ec8b61-e602-41f2-ac1a-64e150b2ce18", "Matt Cavotta");
...
const VOLCANIC_DRAGON_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y1996::mirage::VOLCANIC_DRAGON)
        .with_art("56134669-9575-44bc-9203-edbd75acecbd", "Chris Rahn");
...
const ACIDIC_SLIME_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2009::magic_2010::ACIDIC_SLIME)
        .with_art("ae8e5876-3eff-4075-9fa2-3ab6030848e9", "Karl Kopinski");
...
const AUTUMN_S_VEIL_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2010::magic_2011::AUTUMN_S_VEIL)
        .with_art("b911fee0-c30b-4d68-a9e2-61c40ece68b0", "Kekai Kotaki");

// M12 165 — Birds of Paradise (reprint)
const BIRDS_OF_PARADISE_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y1993::alpha::BIRDS_OF_PARADISE)
        .with_art("307d4236-1e54-43e3-83f1-063d49d16dda", "Marcelo Vignali");

// M12 166 — Bountiful Harvest (reprint)
const BOUNTIFUL_HARVEST_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2009::magic_2010::BOUNTIFUL_HARVEST)
        .with_art("8191e3cb-ef28-40ea-9eab-23455435d49e", "Jason Chan");
...
const BRINDLE_BOAR_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2010::magic_2011::BRINDLE_BOAR)
        .with_art("fc780658-fc10-481e-8319-d44a644e8fe8", "Dave Allsop");
...
const CUDGEL_TROLL_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2009::magic_2010::CUDGEL_TROLL)
        .with_art("e156b8d8-5309-494e-9709-44f98826a69f", "Jesper Ejsing");
...
const ELVISH_ARCHDRUID_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2009::magic_2010::ELVISH_ARCHDRUID)
        .with_art("99f37891-fac7-4868-a20b-0e879f7e0859", "Karl Kopinski");

// M12 173 — Fog (reprint)
const FOG_REPRINT: PrintingRecord = PrintingRecord::reprint(&crate::card::sets::y1993::alpha::FOG)
    .with_art("84387fb5-7929-4d08-9d94-ba2d94460ef3", "Jaime Jones");
...
const GARRUK_S_COMPANION_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2010::magic_2011::GARRUK_S_COMPANION)
        .with_art("b8d8806c-43c5-4c6c-9420-6210a17ec2b0", "Efrem Palacios");
...
const GIANT_SPIDER_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y1993::alpha::GIANT_SPIDER)
        .with_art("460133e5-00f1-47e2-91fe-c36802ef16a8", "Randy Gallegos");
...
const GREATER_BASILISK_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2010::magic_2011::GREATER_BASILISK)
        .with_art("994711cb-e85b-4acb-9460-17231e1d66ad", "James Ryman");
...
const LLANOWAR_ELVES_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y1993::alpha::LLANOWAR_ELVES)
        .with_art("01c6f877-6b00-4d57-8a88-36cd3b16edbc", "Kev Walker");

// M12 183 — Lure (reprint)
const LURE_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y1993::alpha::LURE).with_art(
...
const NATURALIZE_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2002::onslaught::NATURALIZE)
        .with_art("4bf9c75f-0319-416c-904a-49358f2f943c", "Tim Hildebrandt");

// M12 186 — Overrun (reprint)
const OVERRUN_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y1997::tempest::OVERRUN)
        .with_art("ae0559d4-0015-44e4-8ec4-08bb1c54eec5", "Carl Critchlow");
...
const PLUMMET_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2010::archenemy::PLUMMET)
        .with_art("54a1a949-c874-4739-9c7d-ad6fcd2aad44", "Pete Venters");

// M12 188 — Primeval Titan (reprint)
const PRIMEVAL_TITAN_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2010::magic_2011::PRIMEVAL_TITAN)
        .with_art("fd6ddbca-b943-49d6-b341-509bb72dd5a6", "Aleksi Briclot");
...
const RAMPANT_GROWTH_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y1996::mirage::RAMPANT_GROWTH)
        .with_art("fe45a787-6d8a-48d7-ad6c-fb20a9b468a4", "Steven Belledin");

// M12 191 — Reclaim (reprint)
const RECLAIM_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y1998::exodus::RECLAIM)
        .with_art("78f67503-2f0f-43bf-9c4f-a254cc6c501a", "Andrew Robinson");

// M12 192 — Rites of Flourishing (reprint)
const RITES_OF_FLOURISHING_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2007::future_sight::RITES_OF_FLOURISHING)
        .with_art("0e3d43ce-8297-47f6-a877-d723b9b43fdb", "Brandon Kitkouski");

// M12 193 — Runeclaw Bear (reprint)
const RUNECLAW_BEAR_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2009::magic_2010::RUNECLAW_BEAR)
        .with_art("6caf2b93-1971-4702-9aa5-bd223eb37a39", "Jesper Ejsing");

// M12 194 — Sacred Wolf (reprint)
const SACRED_WOLF_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2010::magic_2011::SACRED_WOLF)
        .with_art("ff4661dd-2075-48c3-b19b-fc7f8aaba1b8", "Matt Stewart");
...
const STAMPEDING_RHINO_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2009::magic_2010::STAMPEDING_RHINO)
        .with_art("09d34690-f7cc-4161-9a6f-bfc5393e40b2", "Steven Belledin");
...
const VASTWOOD_GORGER_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2009::zendikar::VASTWOOD_GORGER)
        .with_art("cdd9d448-ebd5-4e01-af88-e755833c2451", "Kieran Yanner");
...
const ANGEL_S_FEATHER_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2004::darksteel::ANGEL_S_FEATHER)
        .with_art("3992dc7c-61c0-4d5f-9c32-8febfad4ef6d", "Alan Pollack");
...
const DEMON_S_HORN_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2004::darksteel::DEMON_S_HORN)
        .with_art("3f56b129-fe2d-4061-b1c9-f1f5a4db564a", "Alan Pollack");

// M12 206 — Dragon's Claw (reprint)
const DRAGON_S_CLAW_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2004::darksteel::DRAGON_S_CLAW)
        .with_art("0d732b87-08e5-41b6-8448-62dd6bf20d9c", "Alan Pollack");
...
const KRAKEN_S_EYE_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2004::darksteel::KRAKEN_S_EYE)
        .with_art("48052433-c4d3-434e-a609-e8400150a0f6", "Alan Pollack");
...
const PENTAVUS_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2003::mirrodin::PENTAVUS)
        .with_art("eb10af81-8ff3-4063-a67a-b760fdba95f8", "Greg Staples");

// M12 214 — Quicksilver Amulet (reprint)
const QUICKSILVER_AMULET_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y1999::urzas_legacy::QUICKSILVER_AMULET)
        .with_art("04c0357a-e98d-4c49-83ad-d7a8ebe7e2d1", "Brad Rigney");
...
const SOLEMN_SIMULACRUM_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2003::mirrodin::SOLEMN_SIMULACRUM)
        .with_art("246d2ce1-6926-4acc-810a-4894dc346b8b", "Dan Murayama Scott");
...
const THRAN_GOLEM_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y1999::urzas_destiny::THRAN_GOLEM)
        .with_art("f01b98a6-5683-4b1b-a14c-d0b50fc26beb", "Ron Spears");
...
const WORLDSLAYER_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2003::mirrodin::WORLDSLAYER)
        .with_art("db6c6b15-40f3-4556-978f-878bedb13762", "Greg Staples");

// M12 223 — Wurm's Tooth (reprint)
const WURM_S_TOOTH_REPRINT: PrintingRecord =
    PrintingRecord::reprint(&crate::card::sets::y2004::darksteel::WURM_S_TOOTH)
        .with_art("da965767-a8b1-4725-ae20-65c18e37ad27", "Alan Pollack");
...
const MOUNTAIN_ALTERNATE_1: PrintingRecord = PrintingRecord::alternate(&catalog_lea::MOUNTAIN, 1)
    .with_art("9c81a162-9735-4c3f-8eee-43b4f3b5a59c", "Karl Kopinski");
...
const MOUNTAIN_ALTERNATE_2: PrintingRecord = PrintingRecord::alternate(&catalog_lea::MOUNTAIN, 2)
    .with_art("1a8d9be0-255a-482a-b055-f483859266c5", "Robh Ruppel");
