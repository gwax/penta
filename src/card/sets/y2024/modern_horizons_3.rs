...
pub(in crate::card::sets) static GLARING_FLESHRAKER: CardRecord = CardRecord::new(
    "Glaring Fleshraker",
        ...
        AbilityDef::triggered(
            ...
            EffectDef::CreateToken(crate::card::CreateTokenDef::new(
                crate::card::TokenDef::Literal(
                    crate::card::TokenCharacteristics::creature(&["Eldrazi", "Spawn"], &[], 0, 1)
                        .with_abilities(&[AbilityDef::activated_mana(
...
pub(in crate::card::sets) static KOZILEK_THE_BROKEN_REALITY: CardRecord = CardRecord::new(
    "Kozilek, the Broken Reality",
    "04066abb-44d2-4730-9cc3-2584bc4c7d8c",
    "Brent Hollowell",
    CardRules::new_creature(mana_cost!("{9}"), &["Eldrazi"], 9, 9)
        .with_supertype(CardSupertype::Legendary)
        .with_abilities(&[
            AbilityDef::triggered_with_targets(
                "When you cast this spell, up to two target players each \
                 manifest two cards from their hands. For each card \
                 manifested this way, you draw a card. (To manifest a card, \
                 put it onto the battlefield face down as a 2/2 creature. \
                 Turn it face up any time for its mana cost if it's a \
                 creature card.)",
                TriggerEventDef::spell_cast(ObjectPredicateDef::Source),
                ...
                EffectDef::ChooseForEachPlayer(ChooseForEachPlayerDef {
                    ...
                    visibility: ChoiceVisibilityDef::Private,
                    chosen: Binding!("kozilek_hands"),
                    unchosen: Binding!("kozilek_remaining"),
                    then: &EffectDef::Sequence(&[
                        EffectDef::ForEachInBinding {
                            objects: Binding!("kozilek_hands"),
                            binding: Binding!("manifest_card"),
                            effect: &EffectDef::PutObjectsOntoBattlefieldFaceDown(
                                PutObjectsOntoBattlefieldFaceDownDef {
                                    input: ObjectSetDef::One(ObjectRefDef::Binding(Binding!(
                                        "manifest_card"
                                    ))),
                                    controller: PlayerRefDef::OwnerOf(ObjectRefDef::Binding(
                                        Binding!("manifest_card"),
                                    )),
                        ...
                        EffectDef::DrawCards {
                            ...
                            amount: ValueDef::Sum(&SumValueDef {
                                ...
                                right: ValueDef::Sum(&SumValueDef {
                                    left: ValueDef::CountObjects(&ObjectSetDef::Query(
                                    ...
                                    right: ValueDef::Negate(&ValueDef::CountObjects(
                                        &ObjectSetDef::Union(&[
                                            ObjectSetDef::ZoneChangeSuccessorsOfBinding(Binding!(
                                                "kozilek_hands"
                                            )),
...
pub(in crate::card::sets) static KOZILEK_S_COMMAND: CardRecord = CardRecord::new(
    "Kozilek's Command",
...
pub(in crate::card::sets) static FLARE_OF_FORTITUDE: CardRecord = CardRecord::new(
    "Flare of Fortitude",
    ...
    CardRules::new_instant(mana_cost!("{2}{W}{W}")).with_abilities(&[
        AbilityDef::alternative_cast(
            ...
            Some(
                "You may sacrifice a nontoken white creature rather than pay \
                 this spell's mana cost.",
            ),
            EffectDef::None,
        ),
        AbilityDef::spell(
            "Until end of turn, your life total can't change, and \
    ...
    CardRules::new_creature(mana_cost!("{W}"), &["Cat"], 1, 1).with_abilities(&[
        ...
        AbilityDef::triggered_if(
            "At the beginning of your end step, if you gained life this \
             turn, create a 1/1 white Cat creature token. Then if you \
             have the city's blessing, for each token you control that \
            ...
            EffectDef::Sequence(&[
                EffectDef::CreateToken(CreateTokenDef::new(TokenDef::Literal(
                    TokenCharacteristics::creature(&["Cat"], &[ManaColor::White], 1, 1).with_art(
                        CardArt::new("74bacab2-a4c6-4ba5-a208-6bd09ae4cf9f", "Maxime Minard"),
                    ),
                ))),
                ...
                EffectDef::Sequence(&[
                    ...
                    EffectDef::InstallTrigger(InstalledTriggerDef::once(&AbilityDef::triggered(
                        "At the beginning of the next end step, return that card to \
                         the battlefield under its owner's control. If it entered \
...
pub(in crate::card::sets) static WRATH_OF_THE_SKIES: CardRecord = CardRecord::new(
    "Wrath of the Skies",
...
pub(in crate::card::sets) static AMPHIBIAN_DOWNPOUR: CardRecord = CardRecord::new(
    "Amphibian Downpour",
...
pub(in crate::card::sets) static CONSIGN_TO_MEMORY: CardRecord = CardRecord::new(
    "Consign to Memory",
...
pub(in crate::card::sets) static HARBINGER_OF_THE_SEAS: CardRecord = CardRecord::new(
...
pub(in crate::card::sets) static STRIX_SERENADE: CardRecord = CardRecord::new(
    "Strix Serenade",
    "42ac5ac7-b2f9-4e6f-af41-7e42ac816374",
    "Filipe Pagliuso",
    CardRules::new_instant(mana_cost!("{U}")).with_ability(AbilityDef::spell_with_targets(
        "Counter target artifact, creature, or planeswalker spell. \
         Its controller creates a 2/2 blue Bird creature token with \
         flying.",
        &[AbilityTargetDef::exactly_one(
            AbilityTargetPredicate::Object {
                object: ObjectPredicateDef::All(&[
...
// Audit: unsupported — Exchange control is available, but protection and hexproof do not have
// an activated-and-triggered-abilities-only targeting restriction. Ordinary hexproof would
// incorrectly prohibit opponents' spells too.
pub(in crate::card::sets) static VOLATILE_STORMDRAKE: CardRecord = CardRecord::new(
    "Volatile Stormdrake",
...
pub(in crate::card::sets) static ACCURSED_MARAUDER: CardRecord = CardRecord::new(
    ...
    CardRules::new_creature(mana_cost!("{1}{B}"), &["Zombie", "Warrior"], 2, 1).with_ability(
        abilities::enters_trigger(
            "When this creature enters, each player sacrifices a \
...
pub(in crate::card::sets) static CHTHONIAN_NIGHTMARE: CardRecord = CardRecord::new(
    "Chthonian Nightmare",
...
pub(in crate::card::sets) static EMPEROR_OF_BONES: CardRecord = CardRecord::new(
    ...
    // paying twice.
    CardRules::new_creature(mana_cost!("{1}{B}"), &["Skeleton", "Noble"], 2, 2).with_abilities(&[
        AbilityDef::triggered_with_targets(
        ...
        AbilityDef::activated(
            "{1}{B}: Adapt 2. (If this creature has no +1/+1 counters on \
             it, put two +1/+1 counters on it.)",
        ...
        AbilityDef::triggered(
            "Whenever one or more +1/+1 counters are put on this \
             creature, put a creature card exiled with this creature \
             onto the battlefield under your control with a finality \
             counter on it. It gains haste. Sacrifice it at the \
                ...
                then: &EffectDef::PutOntoBattlefieldThen {
                    ...
                    then: &EffectDef::Sequence(&[
                        ...
                        EffectDef::InstallTrigger(InstalledTriggerDef::once(
                            &AbilityDef::triggered(
                                "At the beginning of the next end step, sacrifice that \
                                 creature.",
                                TriggerEventDef::StepBegins {
                                    step: TurnStepDef::End,
                                    player: PlayerRelation::Any,
...
pub(in crate::card::sets) static NETHERGOYF: CardRecord = CardRecord::new(
    ...
    CardRules::new_creature(mana_cost!("{B}"), &["Lhurgoyf"], 0, 1).with_abilities(&[
        AbilityDef::static_ability(
        ...
        AbilityDef::alternative_cast(
            ...
            Some(
                "Escape—{2}{B}, Exile any number of other cards from your \
                 graveyard with four or more card types among them. (You may \
    ...
    CardRules::new_instant(mana_cost!("{1}{B}")).with_abilities(&[
        ...
        AbilityDef::activated_with_targets(
            "{1}{B}, Exile this card from your graveyard: Put a +1/+1 \
             counter on target creature you control. Activate only as a \
             sorcery.",
...
pub(in crate::card::sets) static AMPED_RAPTOR: CardRecord = CardRecord::new(
    ...
    CardRules::new_creature(mana_cost!("{1}{R}"), &["Dinosaur"], 2, 1).with_abilities(&[
        abilities::first_strike(),
        abilities::enters_trigger(
            "When this creature enters, you get {E}{E} (two energy \
             counters). Then if you cast it from your hand, exile cards \
             from the top of your library until you exile a nonland \
             card. You may cast that card by paying an amount of {E} \
...
pub(in crate::card::sets) static GHOSTFIRE_SLICE: CardRecord = CardRecord::new(
    "Ghostfire Slice",
...
// Audit: unsupported — Exile identities and delayed moves can be bound, but an installed
// trigger checks its intervening-if condition without the captured object bindings. It cannot
// test whether any of this spell's particular cards remain exiled at the beginning of the end
// step. An unconditional trigger with a resolution-only check would still trigger when the
// printed ability must not.
pub(in crate::card::sets) static GLIMPSE_THE_IMPOSSIBLE: CardRecord = CardRecord::new(
...
// Audit: unsupported — Needs unearth; see First-Sphere Gargantua. The entry-damage trigger
...
// MH3 136 — Siege Smash
pub(in crate::card::sets) static SIEGE_SMASH: CardRecord = CardRecord::new(
    "Siege Smash",
...
pub(in crate::card::sets) static FANATIC_OF_RHONAS: CardRecord = CardRecord::new(
    ...
    CardRules::new_creature(mana_cost!("{1}{G}"), &["Snake", "Druid"], 1, 4).with_abilities(&[
        ...
        AbilityDef::activated_mana_if(
            "Ferocious — {T}: Add {G}{G}{G}{G}. Activate only if you \
        ...
        abilities::eternalize!(
            "Eternalize {2}{G}{G} ({2}{G}{G}, Exile this card from your \
             graveyard: Create a token that's a copy of it, except it's \
             a 4/4 black Zombie Snake Druid with no mana cost. \
                        ...
                        effect: AppliedEffectDef::Rule(
                            AppliedRuleDef::GrantsAlternativeCastFromGraveyard {
                                ...
                                ability: &AbilityDef::alternative_cast(
                                    ...
                                    Some(
                                        "Retrace (You may cast this card from your graveyard by \
                                         discarding a land card in addition to paying its other \
                                         costs.)",
                                    ),
                                    EffectDef::None,
    ...
    CardRules::new_creature(mana_cost!("{1}{G}"), &["Insect", "Monk"], 1, 1)
        ...
        .with_abilities(&[
            AbilityDef::alternative_cast_with_targets(
                ...
                AlternativeCastKindDef::Bestow,
                Some(
                    "Bestow {1}{G} (If you cast this card for its bestow cost, \
                     it's an Aura spell with enchant creature. It becomes a \
            ...
            AbilityDef::triggered(
                "Landfall — Whenever a land you control enters, you may pay \
                 ...
                 creature. If you didn't create a token this way, create a \
...
// Audit: unsupported — Needs a "modified" object predicate. A creature is modified if it has a
// counter on it, is equipped, or is enchanted by an Aura its controller controls;
// ObjectPredicateDef can say the counter half but has no predicate for the whole, and covering
// only counters would silently miss the Equipment and Aura halves this set's payoffs are built
// around.
...
// Audit: unsupported — Needs a modified predicate. "Target modified creature you control" asks
// whether a permanent carries an Aura, Equipment, or counter, and no predicate says it.
...
pub(in crate::card::sets) static OBSTINATE_GARGOYLE: CardRecord = CardRecord::new(
    "Obstinate Gargoyle",
        ...
        &[
            AbilityDef::static_ability(
                "This creature has flying as long as it's modified. \
                 (Equipment, Auras you control, and counters are \
                 modifications.)",
                EffectDef::IfCondition {
...
pub(in crate::card::sets) static PHLAGE_TITAN_OF_FIRES_FURY: CardRecord = CardRecord::new(
    ...
    CardRules::new_creature(mana_cost!("{1}{R}{W}"), &["Elder", "Giant"], 6, 6)
        ...
        .with_abilities(&[
            ...
            escape(&[
                CostDef::Mana(mana_cost!("{R}{R}{W}{W}")),
                CostDef::exile(
                    crate::ObjectPredicateDef::Any,
                    crate::ZoneKind::Graveyard,
                    crate::card::CostQuantityDef::Fixed(5),
                ),
            ]),
        ]),
);
...
// Audit: unsupported — Cast triggers cannot inspect whether no mana was spent on the triggering
// spell.
pub(in crate::card::sets) static VEXING_BAUBLE: CardRecord = CardRecord::new(
    "Vexing Bauble",
...
pub(in crate::card::sets) static BOUNTIFUL_LANDSCAPE: CardRecord = CardRecord::new(
    ...
    CardRules::new_land(&[]).with_abilities(&landscape_abilities(
        "{T}, Sacrifice this land: Search your library for a basic \
         Forest, Island, or Mountain card, put it onto the \
         battlefield tapped, then shuffle.",
...
pub(in crate::card::sets) static CONTAMINATED_LANDSCAPE: CardRecord = CardRecord::new(
    ...
    CardRules::new_land(&[]).with_abilities(&[
        ...
        abilities::landscape_fetch(
            "{T}, Sacrifice this land: Search your library for a basic \
             Plains, Island, or Swamp card, put it onto the battlefield \
             tapped, then shuffle.",
            ObjectPredicateDef::All(&[
                ObjectPredicateDef::Supertype(CardSupertype::Basic),
                ObjectPredicateDef::HasAnyBasicLandType(&[
...
pub(in crate::card::sets) static DECEPTIVE_LANDSCAPE: CardRecord = CardRecord::new(
    ...
    CardRules::new_land(&[]).with_abilities(&[
        ...
        abilities::landscape_fetch(
            "{T}, Sacrifice this land: Search your library for a basic \
             Plains, Swamp, or Forest card, put it onto the battlefield \
             tapped, then shuffle.",
            ObjectPredicateDef::All(&[
                ObjectPredicateDef::Supertype(CardSupertype::Basic),
                ObjectPredicateDef::HasAnyBasicLandType(&[
...
pub(in crate::card::sets) static FOREBODING_LANDSCAPE: CardRecord = CardRecord::new(
    ...
    CardRules::new_land(&[]).with_abilities(&[
        ...
        abilities::landscape_fetch(
            "{T}, Sacrifice this land: Search your library for a basic \
             Swamp, Forest, or Island card, put it onto the battlefield \
             tapped, then shuffle.",
            ObjectPredicateDef::All(&[
                ObjectPredicateDef::Supertype(CardSupertype::Basic),
                ObjectPredicateDef::HasAnyBasicLandType(&[
...
pub(in crate::card::sets) static PERILOUS_LANDSCAPE: CardRecord = CardRecord::new(
    ...
    CardRules::new_land(&[]).with_abilities(&[
        ...
        abilities::landscape_fetch(
            "{T}, Sacrifice this land: Search your library for a basic \
             Island, Mountain, or Plains card, put it onto the \
             battlefield tapped, then shuffle.",
            ObjectPredicateDef::All(&[
                ObjectPredicateDef::Supertype(CardSupertype::Basic),
                ObjectPredicateDef::HasAnyBasicLandType(&[
...
pub(in crate::card::sets) static SPYMASTER_S_VAULT: CardRecord = CardRecord::new(
    "Spymaster's Vault",
...
pub(in crate::card::sets) static TRANQUIL_LANDSCAPE: CardRecord = CardRecord::new(
    ...
    CardRules::new_land(&[]).with_abilities(&[
        ...
        abilities::landscape_fetch(
            "{T}, Sacrifice this land: Search your library for a basic \
             Forest, Plains, or Island card, put it onto the battlefield \
             tapped, then shuffle.",
            ObjectPredicateDef::All(&[
                ObjectPredicateDef::Supertype(CardSupertype::Basic),
                ObjectPredicateDef::HasAnyBasicLandType(&[
...
pub(in crate::card::sets) static TWISTED_LANDSCAPE: CardRecord = CardRecord::new(
    ...
    CardRules::new_land(&[]).with_abilities(&landscape_abilities(
        "{T}, Sacrifice this land: Search your library for a basic \
         Swamp, Mountain, or Forest card, put it onto the \
         battlefield tapped, then shuffle.",
...
// Audit: unsupported — Mana amounts and overrides cannot inspect this source's linked-exile
// set. CountMatchingObjects accepts zone queries but has no exiled-with-this-source predicate,
// and CountObjects over LinkedExiles is not evaluated by the mana planner.
pub(in crate::card::sets) static UGIN_S_LABYRINTH: CardRecord = CardRecord::new(
    "Ugin's Labyrinth",
...
// MH3 234 — Urza's Cave
pub(in crate::card::sets) static URZA_S_CAVE: CardRecord = CardRecord::new(
    "Urza's Cave",
                        ...
                        &const {
                            [
                                abilities::enters_trigger(
                                    ...
                                    EffectDef::CreateToken(CreateTokenDef::new(TokenDef::Literal(CAT_WARRIOR_TOKEN))),
                                ),
                                ...
                                // left to turn over.
                                AbilityDef::triggered(
                                    "Whenever one or more other Cats you control die, you may \
                                     exile Ajani, then return him to the battlefield transformed \
                    ...
                    .with_abilities(
                        &const {
                            [
                                ...
                                AbilityDef::activated_with_targets(
                                    "0: Create a 2/1 white Cat Warrior creature token. When you \
                                    ...
                                    EffectDef::Sequence(
                                        &const {
                                            [
                                                EffectDef::CreateToken(CreateTokenDef::new(
                                                    TokenDef::Literal(CAT_WARRIOR_TOKEN),
                                                )),
                                                EffectDef::IfCondition {
                                                    // "If you control a red permanent other than Ajani." Ajani himself
                                                    // is
                                                    // white, so the clause is about a second permanent rather than
                                                    // about him.
                                                    condition: &TriggerConditionDef::ObjectCount {
                                                        query: ObjectQueryDef::matching(
                                                            ObjectPredicateDef::All(&[
                                                                ObjectPredicateDef::Color(
                                                                    ManaColor::Red,
                                                                ),
...
pub(in crate::card::sets) static RAZORGRASS_AMBUSH_RAZORGRASS_FIELD: CardRecord =
    CardRecord::new_mdfc(
        ...
        &[
            (
                ...
                CardRules::new_instant(mana_cost!("{1}{W}")).with_ability(
                    AbilityDef::spell_with_targets(
                        "Razorgrass Ambush deals 3 damage to target attacking or \
                         blocking creature.",
                        &[AbilityTargetDef::exactly_one_permanent(
                            ObjectPredicateDef::All(&[
                                ObjectPredicateDef::HasType(CardType::Creature),
            ...
            (
                ...
                CardRules::new_land(&[]).with_abilities(&[
                    AbilityDef::replacement(
                        "As this land enters, you may pay 3 life. If you don't, it \
                         enters tapped.",
...
pub(in crate::card::sets) static HYDROELECTRIC_SPECIMEN_HYDROELECTRI: CardRecord =
    CardRecord::new_mdfc(
        ...
        &[
            (
                ...
                CardRules::new_creature(mana_cost!("{2}{U}"), &["Weird"], 1, 4).with_abilities(&[
                    abilities::flash(),
                    abilities::enters_trigger_with_targets(
                        "When this creature enters, you may change the target of \
                         target instant or sorcery spell with a single target to \
                         this creature.",
                        &[AbilityTargetDef::exactly_one(
                            AbilityTargetPredicate::Object {
                                object: ObjectPredicateDef::All(&[
                        ...
                        EffectDef::May {
                            player: EffectRecipientDef::Controller,
                            effect: &EffectDef::ChangeStackTargets(
                                &crate::card::ChangeStackTargetsDef {
                                    object: EffectRecipientDef::Target(TargetIndex::PRIMARY),
                                    chooser: PlayerRefDef::EffectController,
        ...
        (
            ...
            const {
                CardRules::new_instant(mana_cost!("{1}{U}{U}")).with_ability(
                    AbilityDef::spell_with_targets(
                        "Return target spell or nonland permanent an opponent \
...
pub(in crate::card::sets) static BOGGART_TRAWLER_BOGGART_BOG: CardRecord = CardRecord::new_mdfc(
...
pub(in crate::card::sets) static FELL_THE_PROFANE_FELL_MIRE: CardRecord = CardRecord::new_mdfc(
...
pub(in crate::card::sets) static PINNACLE_MONK_MYSTIC_PEAK: CardRecord = CardRecord::new_mdfc(
    ...
    &[
        (
            "Pinnacle Monk",
            CardRules::new_creature(mana_cost!("{3}{R}{R}"), &["Djinn", "Monk"], 2, 2)
                .with_abilities(&[
                    abilities::prowess(),
                    abilities::enters_trigger_with_targets(
...
pub(in crate::card::sets) static SUNDERING_ERUPTION_VOLCANIC_FISSURE: CardRecord =
    CardRecord::new_mdfc(
        ...
        &[
            (
                ...
                CardRules::new_sorcery(mana_cost!("{2}{R}")).with_ability(
                    AbilityDef::spell_with_targets(
                        "Destroy target land. Its controller may search their \
                         library for a basic land card, put it onto the battlefield \
                         tapped, then shuffle. Creatures without flying can't block \
                         this turn.",
                        &[AbilityTargetDef::exactly_one_permanent(
                            ObjectPredicateDef::HasType(CardType::Land),
                        )],
...
pub(in crate::card::sets) static BRIDGEWORKS_BATTLE_TANGLESPAN_BRIDGEWORKS: CardRecord =
    CardRecord::new_mdfc(
...
pub(in crate::card::sets) static DISCIPLE_OF_FREYALISE_GARDEN_OF_FREYALISE: CardRecord =
    CardRecord::new_mdfc(
        ...
        &[
            (
                ...
                CardRules::new_creature(mana_cost!("{3}{G}{G}{G}"), &["Elf", "Druid"], 3, 3)
                    .with_ability(abilities::enters_trigger(
                        "When this creature enters, you may sacrifice another \
                         creature. If you do, you gain X life and draw X cards, \
...
pub(in crate::card::sets) static WATERLOGGED_TEACHINGS_INUNDATED_ARCHIVE: CardRecord =
    CardRecord::new_mdfc(
        ...
        &[
            (
                ...
                CardRules::new_instant(mana_cost!("{3}{U/B}")).with_ability(AbilityDef::spell(
...
// Audit: unsupported — TriggerModificationDef supports zone-change causes. It cannot double
// arbitrary triggers of colorless spells or permanents, including spell-cast and upkeep
// triggers.
pub(in crate::card::sets) static ECHOES_OF_ETERNITY: CardRecord = CardRecord::new(
    "Echoes of Eternity",
...
// Audit: unsupported — The engine does not grant convoke to spells conditionally on their being
// cast from exile. The cast-cost scanner handles intrinsic payment keywords, not this
// zone-dependent continuous grant.
pub(in crate::card::sets) static PARTY_THRASHER: CardRecord = CardRecord::new(
    "Party Thrasher",
...
// Audit: unsupported — Immediate free-cast offers accept only graveyard or exile cards. They
// cannot cast the revealed top card directly from the library during this trigger; exiling it
// first changes the printed behavior.
pub(in crate::card::sets) static POWERBALANCE: CardRecord = CardRecord::new(
    "Powerbalance",
...
// Audit: unsupported — There is no consumable permission granting improvise to only the next
// spell cast this turn. The next-cast lifetime currently applies to cast-timing permissions,
// not payment keywords.
pub(in crate::card::sets) static ARCHWAY_OF_INNOVATION: CardRecord = CardRecord::new(
        ...
        .with_abilities(&[
            ...
            AbilityDef::static_ability(
                "Creatures you control have \"Whenever this creature becomes \
                 the target of a spell or ability, reveal the top card of \
                 your library. If it's a land card, put it onto the \
                 battlefield. Otherwise, put it into your hand. This ability \
                    ...
                    effect: AppliedEffectDef::add_ability(
                        &AbilityDef::triggered(
                            "Whenever this creature becomes the target of a spell or \
                             ability, reveal the top card of your library. If it's a \
                             land card, put it onto the battlefield. Otherwise, put it \
...
// Audit: unsupported — The entry-value interpreter cannot compute AggregateObjectValues over
// exiled cards. Its greatest-exiled-mana-value entry counter count cannot be supplied to
// AddCountersValue.
pub(in crate::card::sets) static ULAMOG_THE_DEFILER: CardRecord = CardRecord::new(
    "Ulamog, the Defiler",
...
pub(in crate::card::sets) static NULL_ELEMENTAL_BLAST: CardRecord = CardRecord::new(
...
pub(in crate::card::sets) static FLARE_OF_DENIAL: CardRecord = CardRecord::new(
    "Flare of Denial",
    ...
    CardRules::new_instant(mana_cost!("{1}{U}{U}")).with_abilities(&[
        AbilityDef::alternative_cast(
            ...
            AlternativeCastKindDef::AlternativeCost,
            Some(
                "You may sacrifice a nontoken blue creature rather than pay \
                 this spell's mana cost.",
            ),
            EffectDef::None,
        ),
...
pub(in crate::card::sets) static GRIM_SERVANT: CardRecord = CardRecord::new(
    "Grim Servant",
    ...
    CardRules::new_creature(mana_cost!("{3}{B}"), &["Zombie", "Warlock"], 3, 2).with_abilities(&[
        ...
        abilities::enters_trigger(
            "When this creature enters, search your library for a card \
             with mana value less than or equal to your devotion to \
             black, reveal it, put it into your hand, then shuffle. You \
             lose 3 life. (Each {B} in the mana costs of permanents you \
...
pub(in crate::card::sets) static MARIONETTE_APPRENTICE: CardRecord = CardRecord::new(
    "Marionette Apprentice",
    "22b5a3dd-0b5a-434e-afee-a83b0279fd15",
    "Steve Ellis",
    CardRules::new_creature(mana_cost!("{1}{B}"), &["Human", "Artificer"], 1, 2).with_abilities(&[
        abilities::enters_trigger(
            "Fabricate 1 (When this creature enters, put a +1/+1 counter \
             on it or create a 1/1 colorless Servo artifact creature \
             token.)",
        ...
        AbilityDef::triggered(
            "Whenever another creature or artifact you control is put \
             into a graveyard from the battlefield, each opponent loses \
             1 life.",
            TriggerEventDef::zone_changed(
                ObjectPredicateDef::All(&[
                    ObjectPredicateDef::AnyOf(&[
...
// Audit: unsupported — Player rules can modify maximum hand size or remove the limit, but
// cannot set the base maximum to five. A minus-two modifier is not equivalent when another
// effect sets that maximum.
pub(in crate::card::sets) static NECRODOMINANCE: CardRecord = CardRecord::new(
    "Necrodominance",
...
pub(in crate::card::sets) static WARREN_SOULTRADER: CardRecord = CardRecord::new(
    "Warren Soultrader",
    "17fd4d15-413f-41c5-b3e0-71bbb52851bc",
    "Pete Venters",
    CardRules::new_creature(mana_cost!("{2}{B}"), &["Zombie", "Goblin", "Wizard"], 3, 3)
        .with_abilities(&[AbilityDef::activated(
            "Pay 1 life, Sacrifice another creature: Create a Treasure \
...
pub(in crate::card::sets) static FLARE_OF_DUPLICATION: CardRecord = CardRecord::new(
...
// Audit: unsupported — The exile-play permission has no lifetime ending when this same
// permanent next exiles a card. This-turn and while-exiled permissions both authorize the wrong
// plays.
pub(in crate::card::sets) static UNSTABLE_AMULET: CardRecord = CardRecord::new(
    "Unstable Amulet",
...
// Audit: unsupported — There is no discover procedure. Cascade uses a strict mana-value bound
// and lacks discover's choice to put the matched card into hand, so substituting cascade
// changes the card.
pub(in crate::card::sets) static MONSTROUS_VORTEX: CardRecord = CardRecord::new(
    "Monstrous Vortex",
                            ...
                            [
                                AbilityDef::activated(
                                    ...
                                    EffectDef::InstallTrigger(InstalledTriggerDef {
                                        ...
                                        lifetime: InstalledTriggerLifetimeDef::UntilNextTurn(
                                            PlayerRefDef::EffectController,
                                        ),
                                    }),
                                ),
                                            ...
                                            [
                                                ...
                                                EffectDef::AddMana(
                                                    AddManaEffectDef::any_color()
                                                        // "If it's a green card, add one mana of any color." One mana
                                                        // when the card
                                                        // returned was green and none otherwise, which is the whole
                                                        // rider: an
                                                        // amount rather than a branch, read off the target the clause
                                                        // already has.
                                                        .with_variable_amount(ValueDef::IfTargetMatches(
                                                            &TargetConditionDef {
                                            ...
                                            [
                                                EffectDef::DrawCards {
                                                    ...
                                                    amount: ValueDef::Halved(&HalvedValueDef::new(
                                                        ValueDef::LibrarySize(PlayerRelation::You),
                                                        RoundingDef::Up,
                                                    )),
                                                },
                    ...
                    .with_abilities(
                        &const {
                            [
                                ...
                                abilities::extort(),
                                AbilityDef::triggered_if(
                                    "At the beginning of each of your postcombat main phases, if \
                                     you gained 3 or more life this turn, exile Sorin, then \
                                     return him to the battlefield transformed under his owner's \
                                     control.",
                                    TriggerEventDef::StepBegins {
                    ...
                    .with_abilities(
                        &const {
                            [
                                ...
                                AbilityDef::activated_with_targets(
                                    "\u{2212}6: Gain control of target creature. It becomes a \
                                        ...
                                        &const {
                                            [
                                                ...
                                                EffectDef::Apply {
                                                    ...
                                                    // "It becomes a Vampire in addition to its other types": added
                                                    // rather than
                                                    // set, and with no duration, so what it was stays and the Vampire
                                                    // sticks.
                                                    effect: AppliedEffectDef::Characteristic(
                                                        CharacteristicOperationDef::CreatureTypes(
                                                            SetOperationDef::Add(
                                                                CreatureTypeSetDef::named(&[
                                                                    "Vampire",
                                                                ]),
                                                            ),
                                                        ),
                                                ...
                                                EffectDef::IfCondition {
                                                    // "A white permanent other than that creature or Sorin." The source
                                                    // is
                                                    // Sorin; the creature is the one this ability just took, which is
                                                    // why the
                                                    // query has to leave the target out rather than merely counting
                                                    // what you
                                                    // control.
                                                    condition: &TriggerConditionDef::ObjectCount {
                                                        query: ObjectQueryDef::matching(
...
// Audit: unsupported — The back face's +1 must install a temporary instant/sorcery cost
// reduction until your next turn. ModifyCost is a static operation; the resolving-effect and
// ongoing-effect procedures cannot install that duration-scoped static discount.
pub(in crate::card::sets) static RAL_MONSOON_MAGE_RAL_LEYLINE_PRODIGY: CardRecord = CardRecord::new(
...
pub(in crate::card::sets) static GUIDE_OF_SOULS: CardRecord = CardRecord::new(
    ...
    CardRules::new_creature(mana_cost!("{W}"), &["Human", "Cleric"], 1, 2).with_abilities(&[
        AbilityDef::triggered(
            "Whenever another creature you control enters, you gain 1 \
             life and get {E} (an energy counter).",
            TriggerEventDef::zone_changed(
                ObjectPredicateDef::All(&[
                    ObjectPredicateDef::HasType(CardType::Creature),
                    ObjectPredicateDef::ControlledBy(PlayerRelation::You),
        ...
        AbilityDef::triggered_with_targets(
            "Whenever you attack, you may pay {E}{E}{E}. When you do, \
             put two +1/+1 counters and a flying counter on target \
             attacking creature. It becomes an Angel in addition to its \
             other types.",
...
pub(in crate::card::sets) static DREAMTIDE_WHALE: CardRecord = CardRecord::new(
    "Dreamtide Whale",
    "966e2066-ef45-4882-a420-247115a319b9",
    "Ron Spears",
    CardRules::new_creature(mana_cost!("{2}{U}"), &["Whale"], 7, 5).with_abilities(&[
        AbilityDef::as_enters(
            "Vanishing 2 (This creature enters with two time counters on \
             it. At the beginning of your upkeep, remove a time counter \
             from it. When the last is removed, sacrifice it.)",
            ReplacementEffectDef::ModifyBattlefieldEntry(
                BattlefieldEntryModificationDef::AddCounters {
        ...
        AbilityDef::triggered_if(
            "At the beginning of your upkeep, if this creature has a \
             time counter on it, remove a time counter from it.",
            TriggerEventDef::StepBegins {
                step: TurnStepDef::Upkeep,
                player: PlayerRelation::You,
            },
        ...
        AbilityDef::triggered(
            "When the last time counter is removed from this creature, \
             sacrifice it.",
        ...
        AbilityDef::triggered(
            ...
            TriggerEventDef::While {
                event: &TriggerEventDef::spell_cast(ObjectPredicateDef::Any),
...
pub(in crate::card::sets) static CRABOMINATION: CardRecord = CardRecord::new(
    ...
    CardRules::new_creature(mana_cost!("{4}{B}{B}"), &["Crab", "Demon"], 5, 5).with_abilities(&[
        ...
        abilities::enters_trigger_with_targets(
            "When this creature enters, target opponent exiles the top \
             card of their library, a card at random from their \
             graveyard, and a card at random from their hand. You may \
             cast a spell from among cards exiled this way without \
...
pub(in crate::card::sets) static RIPPLES_OF_UNDEATH: CardRecord = CardRecord::new(
    "Ripples of Undeath",
    "0136a022-6b16-4b33-a817-946ded4e9dd5",
    "Ben Wootten",
    CardRules::new_enchantment(mana_cost!("{1}{B}")).with_abilities(&[AbilityDef::triggered(
        "At the beginning of your first main phase, mill three \
         cards. Then you may pay {1} and 3 life. If you do, put a \
         card from among those cards into your hand.",
        TriggerEventDef::StepBegins {
            step: TurnStepDef::PrecombatMain,
            player: PlayerRelation::You,
        },
        EffectDef::BindObjects(BindObjectsDef {
            ...
            then: &EffectDef::Sequence(&[
                ...
                EffectDef::PayOr(PayOrDef::optional(
                    &[CostDef::Mana(mana_cost!("{1}")), CostDef::PayLife(3)],
                    &EffectDef::Choose(ChooseDef {
                        chooser: PlayerRefDef::EffectController,
                        candidates: ObjectSetDef::ZoneChangeSuccessorsOfBinding(Binding!(
                            "ripples_top"
                        )),
                        exclude: None,
                        minimum: 1,
                        maximum: 1,
                        binding: ObjectChoiceBindingDef::Objects(Binding!("ripples_return")),
                        unchosen: None,
                        visibility: ChoiceVisibilityDef::Private,
                        then: &EffectDef::move_to_zone(
...
// MH3 462 — Winter Moon
pub(in crate::card::sets) static WINTER_MOON: CardRecord = CardRecord::new(
    "Winter Moon",
...
// Audit: unsupported — The engine can author an individual emerge cost but cannot grant emerge
// using each creature spell's own mana cost to all of a player's creature spells.
pub(in crate::card::sets) static HERIGAST_ERUPTING_NULLKITE: CardRecord = CardRecord::new(
...
pub(in crate::card::sets) static CARDS: &[&CardRecord] = &[
    ...
    &URZA_S_CAVE,
    &AJANI_NACATL_PARIAH,
    &RAZORGRASS_AMBUSH_RAZORGRASS_FIELD,
    &WITCH_ENCHANTER,
    &HYDROELECTRIC_SPECIMEN_HYDROELECTRI,
    &SINK_INTO_STUPOR,
    &BOGGART_TRAWLER_BOGGART_BOG,
    &FELL_THE_PROFANE_FELL_MIRE,
    &PINNACLE_MONK_MYSTIC_PEAK,
    &SUNDERING_ERUPTION_VOLCANIC_FISSURE,
    &BRIDGEWORKS_BATTLE_TANGLESPAN_BRIDGEWORKS,
    &DISCIPLE_OF_FREYALISE_GARDEN_OF_FREYALISE,
    &WATERLOGGED_TEACHINGS_INUNDATED_ARCHIVE,
    &ECHOES_OF_ETERNITY,
    &PARTY_THRASHER,
    &POWERBALANCE,
    &ARCHWAY_OF_INNOVATION,
    &ARENA_OF_GLORY,
    &NADU_WINGED_WISDOM,
    &ULAMOG_THE_DEFILER,
    ...
    &NECRODOMINANCE,
    &WARREN_SOULTRADER,
    &FLARE_OF_DUPLICATION,
    &UNSTABLE_AMULET,
    &MONSTROUS_VORTEX,
    &TAMIYO_INQUISITIVE_STUDENT,
    &SORIN_OF_HOUSE_MARKOV,
    &RAL_MONSOON_MAGE_RAL_LEYLINE_PRODIGY,
    &GUIDE_OF_SOULS,
    &DREAMTIDE_WHALE,
    &CRABOMINATION,
    &RIPPLES_OF_UNDEATH,
