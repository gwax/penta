...
pub(in crate::card::sets) static RAVAGES_OF_WAR: CardRecord = CardRecord::new(
    "Ravages of War",
...
pub(in crate::card::sets) static CAPTURE_OF_JINGZHOU: CardRecord = CardRecord::new(
    "Capture of Jingzhou",
...
pub(in crate::card::sets) static IMPERIAL_RECRUITER: CardRecord = CardRecord::new(
    "Imperial Recruiter",
...
pub(in crate::card::sets) static WARRIOR_S_OATH: CardRecord = CardRecord::new(
    "Warrior's Oath",
...
pub(in crate::card::sets) static THREE_VISITS: CardRecord = CardRecord::new(
    "Three Visits",
