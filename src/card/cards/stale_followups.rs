...
pub const HEAVENS_GATE: CardDefinitionId = CardDefinitionId(1766);
pub const SEA_KINGS_BLESSING: CardDefinitionId = CardDefinitionId(1767);
...
pub const BENALISH_HERO: CardDefinitionId = CardDefinitionId(1772);
pub const MESA_PEGASUS: CardDefinitionId = CardDefinitionId(1773);
