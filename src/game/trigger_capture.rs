...
use super::{
    ...
    ScopedEffect, StackAbilityResolver, StackObject, StackObjectEventDef, StackObjectKind,
    StackTargetAggregationDef, StackTargetFilterDef, TapPurposeDef, Target, TextWordMap,
    TextWordView, TriggerCapture, TriggerContext, TriggerEventDef, TriggerEventObject, ZoneKind,
};
                ...
                let (definition, effect, resolver, uses_stack) = match ability.definition {
                    DeclarativeAbilityDef::TriggeredMana(definition) => {
                        ...
                        (
                            definition,
                            effect,
                            self.cached_ability_resolver(effective.origin, &ability),
                            false,
                        )
                    }
