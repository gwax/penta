...
pub(in crate::game::state_checkpoint) fn keyword_snapshot(
    ...
    match keyword {
        ...
        KeywordAbility::Changeling => KeywordSnapshot::Changeling,
        ...
        KeywordAbility::Flanking => KeywordSnapshot::Flanking,
...
pub(in crate::game::state_checkpoint) const fn parse_keyword(
    ...
    match value {
        ...
        KeywordSnapshot::Changeling => KeywordAbility::Changeling,
        ...
        KeywordSnapshot::Flanking => KeywordAbility::Flanking,
...
const fn parse_protection_keyword(value: KeywordSnapshot) -> KeywordAbility {
    match value {
        ...
        KeywordSnapshot::ProtectionFromNonHumanCreatures => KeywordAbility::ProtectionFrom(
            &const {
                ObjectPredicateDef::All(&[
                    ObjectPredicateDef::HasType(CardType::Creature),
                    ObjectPredicateDef::Not(&ObjectPredicateDef::Subtype(
