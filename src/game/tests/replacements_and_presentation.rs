...
fn an_entering_permanents_own_static_ability_can_grant_its_entry_replacement() {
    let definition_id = CardDefinitionId::from_uuid("00000000-0000-0000-0000-000000002775");
...
fn an_entering_permanents_own_static_land_types_match_external_replacements() {
    let external_id = CardDefinitionId::from_uuid("00000000-0000-0000-0000-000000002775");
    let land_id = CardDefinitionId::from_uuid("00000000-0000-0000-0000-000000002776");
...
fn an_entering_static_effect_does_not_change_existing_replacement_sources_early() {
    let source_id = CardDefinitionId::from_uuid("00000000-0000-0000-0000-000000002775");
...
fn a_land_play_option_locks_the_presented_part_on_the_permanent() {
    let definition_id = CardDefinitionId::from_uuid("00000000-0000-0000-0000-000000002774");
...
fn a_modal_spell_resolves_by_its_locked_part_instead_of_the_canonical_front() {
    let definition_id = CardDefinitionId::from_uuid("00000000-0000-0000-0000-0000000027a6");
