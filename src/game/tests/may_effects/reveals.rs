use super::*;
use crate::card::{RevealObjectsDef, RevealTopCardsDef};

const REVEAL_TWO: EffectDef = EffectDef::RevealTopCards(RevealTopCardsDef {
    player: PlayerRefDef::EffectController,
    count: ValueDef::Constant(2),
    revealed: Binding!("revealed"),
...
fn may_effects_allow_zero_count_and_empty_collection_reveals() {
    static ZERO: EffectDef = EffectDef::RevealTopCards(RevealTopCardsDef {
        player: PlayerRefDef::EffectController,
...
fn may_effects_counted_reveal_reads_bound_counts_through_sequences() {
    static BOUND: EffectDef = EffectDef::BindValue {
        ...
        effect: &EffectDef::Sequence(&[
            EffectDef::RevealTopCards(RevealTopCardsDef {
                player: PlayerRefDef::EffectController,
