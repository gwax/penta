...
pub(in crate::game) const fn assassin_token() -> TokenCharacteristics {
    crate::card::TokenCharacteristics::creature(&["Assassin"], &[ManaColor::Black], 1, 1)
        .with_abilities(&ASSASSIN_ABILITIES)
}
...
pub(in crate::game) const fn wolves_of_the_hunt_token() -> TokenCharacteristics {
    crate::card::TokenCharacteristics::creature(&["Wolf"], &[ManaColor::Green], 1, 1)
...
pub(in crate::game) const fn poisonous_snake_token() -> TokenCharacteristics {
    crate::card::TokenCharacteristics::artifact_creature(&["Snake"], &[], 1, 1)
        .with_abilities(&POISONOUS_SNAKE_ABILITIES)
}
