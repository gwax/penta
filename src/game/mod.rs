...
use crate::card::{
    ...
    CardDefinition, CardEffectStatus, CardPart, CardRules, CardSet, CardSupertype,
    ...
    ManaCost, ManaRestrictionDef, ManaSelectionDef, ManaSpendEffectDef, ManaTypeDef,
    ManaTypeFilterDef, ManaTypeSetDef, ManaTypeSourceDef, ObjectCountConditionDef,
...
use text_changes::{TextWordMap, TextWordView};
use trigger_state::{
